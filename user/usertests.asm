...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    51e8:	00004797          	auipc	a5,0x4
    51ec:	2a87b783          	ld	a5,680(a5) # 9490 <freep>
    ...
    5214:	00e6ea63          	bltu	a3,a4,5228 <free+0x4a>
{
  ...
  if(p + p->s.size == bp){
    ...
    p->s.ptr = bp;
  freep = p;
    5252:	00004717          	auipc	a4,0x4
    5256:	22f73f23          	sd	a5,574(a4) # 9490 <freep>
}
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    ...
    5280:	21453503          	ld	a0,532(a0) # 9490 <freep>
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    if(p == freep)
    52ac:	00004917          	auipc	s2,0x4
    52b0:	1e490913          	addi	s2,s2,484 # 9490 <freep>
  if(p == SBRK_ERROR)
    52b4:	5afd                	li	s5,-1
    ...
    base.s.ptr = freep = prevp = &base;
    52c0:	0000b797          	auipc	a5,0xb
    52c4:	9f878793          	addi	a5,a5,-1544 # fcb8 <base>
    52c8:	00004717          	auipc	a4,0x4
    52cc:	1cf73423          	sd	a5,456(a4) # 9490 <freep>
  ...
  if(p == SBRK_ERROR)
    ...
    5332:	0137a423          	sw	s3,8(a5)
      freep = prevp;
    5336:	00004717          	auipc	a4,0x4
    533a:	14a73d23          	sd	a0,346(a4) # 9490 <freep>
      return (void*)(p + 1);
