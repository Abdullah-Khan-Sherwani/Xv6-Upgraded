   ...
   2:	0ea7de63          	bge	a5,a0,fe <main+0xfe>
{
  ...
  3e:	92650513          	addi	a0,a0,-1754 # 960 <malloc+0xe2>
  42:	782000ef          	jal	ra,7c4 <printf>
      exit(1);
  46:	4505                	li	a0,1
  ...
  ae:	8ce50513          	addi	a0,a0,-1842 # 978 <malloc+0xfa>
  b2:	712000ef          	jal	ra,7c4 <printf>
        exit(1);
  b6:	4505                	li	a0,1
  ...
  c2:	8d250513          	addi	a0,a0,-1838 # 990 <malloc+0x112>
  c6:	6fe000ef          	jal	ra,7c4 <printf>
          exit(1);
  ca:	4505                	li	a0,1
...
printint(int fd, long long xx, int base, int sgn)
{
 ...
 488:	52c50513          	addi	a0,a0,1324 # 9b0 <digits>
 48c:	883e                	mv	a6,a5
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 548:	46cc8c93          	addi	s9,s9,1132 # 9b0 <digits>
 ...
 76c:	24090913          	addi	s2,s2,576 # 9a8 <malloc+0x12a>
        for(; *s; s++)
...
malloc(uint nbytes)
{
 ...
 8ce:	73690913          	addi	s2,s2,1846 # 1000 <freep>
  if(p == SBRK_ERROR)
 8d2:	5afd                	li	s5,-1
 8d4:	a0bd                	j	942 <malloc+0xc4>
    base.s.ptr = freep = prevp = &base;
 8d6:	00001797          	auipc	a5,0x1
 8da:	93278793          	addi	a5,a5,-1742 # 1208 <base>
 ...
 930:	ec7ff0ef          	jal	ra,7f6 <free>
  return freep;
 934:	00093503          	ld	a0,0(s2)
      if((p = morecore(nunits)) == 0)
 938:	dd61                	beqz	a0,910 <malloc+0x92>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 93a:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
 93c:	4798                	lw	a4,8(a5)
 93e:	fa9778e3          	bgeu	a4,s1,8ee <malloc+0x70>
    if(p == freep)
 942:	00093703          	ld	a4,0(s2)
 946:	853e                	mv	a0,a5
 948:	fef719e3          	bne	a4,a5,93a <malloc+0xbc>
  p = sbrk(nu * sizeof(Header));
 94c:	8552                	mv	a0,s4
 94e:	a17ff0ef          	jal	ra,364 <sbrk>
  if(p == SBRK_ERROR)
 952:	fd551ce3          	bne	a0,s5,92a <malloc+0xac>
        return 0;
 956:	4501                	li	a0,0
 958:	bf65                	j	910 <malloc+0x92>
