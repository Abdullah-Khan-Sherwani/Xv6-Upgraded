...
main(int argc, char *argv[])
{
  ...
  if(getprocinfo(&info) < 0) {
   ...
   c:	3ba000ef          	jal	ra,3c6 <getprocinfo>
  ...
  18:	8f450513          	addi	a0,a0,-1804 # 908 <malloc+0xfc>
  1c:	736000ef          	jal	ra,752 <printf>
  printf("  PID: %d\n", info.pid);
  20:	fe042583          	lw	a1,-32(s0)
  24:	00001517          	auipc	a0,0x1
  28:	8fc50513          	addi	a0,a0,-1796 # 920 <malloc+0x114>
  2c:	726000ef          	jal	ra,752 <printf>
  printf("  State: %d\n", info.state);
  30:	fe442583          	lw	a1,-28(s0)
  34:	00001517          	auipc	a0,0x1
  38:	8fc50513          	addi	a0,a0,-1796 # 930 <malloc+0x124>
  3c:	716000ef          	jal	ra,752 <printf>
  printf("  Priority Queue: %d (0=highest, 3=lowest)\n", info.priority);
  40:	fe842583          	lw	a1,-24(s0)
  44:	00001517          	auipc	a0,0x1
  48:	8fc50513          	addi	a0,a0,-1796 # 940 <malloc+0x134>
  4c:	706000ef          	jal	ra,752 <printf>
  printf("  Time Slices Used: %d\n", info.time_slices);
  50:	fec42583          	lw	a1,-20(s0)
  54:	00001517          	auipc	a0,0x1
  58:	91c50513          	addi	a0,a0,-1764 # 970 <malloc+0x164>
  5c:	6f6000ef          	jal	ra,752 <printf>
  printf("\nMLFQ Scheduler Test - Week 1\n");
  60:	00001517          	auipc	a0,0x1
  64:	92850513          	addi	a0,a0,-1752 # 988 <malloc+0x17c>
  68:	6ea000ef          	jal	ra,752 <printf>
  printf("Successfully retrieved process info via getprocinfo syscall!\n");
  6c:	00001517          	auipc	a0,0x1
  70:	93c50513          	addi	a0,a0,-1732 # 9a8 <malloc+0x19c>
  74:	6de000ef          	jal	ra,752 <printf>
  ...
  82:	87250513          	addi	a0,a0,-1934 # 8f0 <malloc+0xe4>
  86:	6cc000ef          	jal	ra,752 <printf>
    exit(1);
  8a:	4505                	li	a0,1
...
printint(int fd, long long xx, int base, int sgn)
{
 ...
 416:	5de50513          	addi	a0,a0,1502 # 9f0 <digits>
 41a:	883e                	mv	a6,a5
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4d6:	51ec8c93          	addi	s9,s9,1310 # 9f0 <digits>
 ...
 6fa:	2f290913          	addi	s2,s2,754 # 9e8 <malloc+0x1dc>
        for(; *s; s++)
