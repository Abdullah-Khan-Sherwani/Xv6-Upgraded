...
copyinstr1(char *s)
{
  ...
  uint64 addrs[] = { 0x80000000LL, 0x3fffffe000, 0x3ffffff000, 0x4000000000,
      ...
      12:	86a78793          	addi	a5,a5,-1942 # 7878 <malloc+0x2662>
      16:	638c                	ld	a1,0(a5)
      18:	6790                	ld	a2,8(a5)
      1a:	6b94                	ld	a3,16(a5)
      1c:	6f98                	ld	a4,24(a5)
  ...
  for(int ai = 0; ai < sizeof(addrs)/sizeof(addrs[0]); ai++){
      ...
      6a:	2ba50513          	addi	a0,a0,698 # 5320 <malloc+0x10a>
      6e:	0ee050ef          	jal	ra,515c <printf>
      exit(1);
      72:	4505                	li	a0,1
      ...
      94:	8082                	ret
{
      ...
      a4:	2a050513          	addi	a0,a0,672 # 5340 <malloc+0x12a>
      a8:	0b4050ef          	jal	ra,515c <printf>
      exit(1);
      ac:	4505                	li	a0,1
...
00000000000000b2 <opentest>:
{
  ...
  fd = open("echo", 0);
      ...
      c4:	29850513          	addi	a0,a0,664 # 5358 <malloc+0x142>
  ...
  fd = open("doesnotexist", 0);
      ...
      da:	2a250513          	addi	a0,a0,674 # 5378 <malloc+0x162>
  ...
  if(fd >= 0){
    ...
    printf("%s: open echo failed!\n", s);
      ...
      f6:	26e50513          	addi	a0,a0,622 # 5360 <malloc+0x14a>
      fa:	062050ef          	jal	ra,515c <printf>
    exit(1);
      fe:	4505                	li	a0,1
    ...
    printf("%s: open doesnotexist succeeded!\n", s);
     ...
     10a:	28250513          	addi	a0,a0,642 # 5388 <malloc+0x172>
     10e:	04e050ef          	jal	ra,515c <printf>
    exit(1);
     112:	4505                	li	a0,1
...
0000000000000118 <truncate2>:
{
  ...
  unlink("truncfile");
     ...
     180:	23450513          	addi	a0,a0,564 # 53b0 <malloc+0x19a>
  ...
  close(fd2);
    ...
    printf("%s: write returned %d, expected -1\n", s, n);
     ...
     1aa:	22a50513          	addi	a0,a0,554 # 53d0 <malloc+0x1ba>
     1ae:	7af040ef          	jal	ra,515c <printf>
    exit(1);
     1b2:	4505                	li	a0,1
...
000000000000022c <bigwrite>:
{
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
     ...
     2c6:	14650513          	addi	a0,a0,326 # 5408 <malloc+0x1f2>
     2ca:	693040ef          	jal	ra,515c <printf>
      exit(1);
     2ce:	4505                	li	a0,1
     ...
     2e2:	14a50513          	addi	a0,a0,330 # 5428 <malloc+0x212>
     2e6:	677040ef          	jal	ra,515c <printf>
        exit(1);
     2ea:	4505                	li	a0,1
...
badwrite(char *s)
{
  ...
  unlink("junk");
     ...
     304:	14050513          	addi	a0,a0,320 # 5440 <malloc+0x22a>
     308:	279040ef          	jal	ra,4d80 <unlink>
     30c:	25800913          	li	s2,600
  for(int i = 0; i < assumed_free; i++){
    int fd = open("junk", O_CREATE|O_WRONLY);
     310:	00005997          	auipc	s3,0x5
     314:	13098993          	addi	s3,s3,304 # 5440 <malloc+0x22a>
    if(fd < 0){
  ...
  int fd = open("junk", O_CREATE|O_WRONLY);
     ...
     350:	0f450513          	addi	a0,a0,244 # 5440 <malloc+0x22a>
  ...
  if(write(fd, "x", 1) != 1){
     ...
     364:	06858593          	addi	a1,a1,104 # 53c8 <malloc+0x1b2>
     368:	1e9040ef          	jal	ra,4d50 <write>
     36c:	4785                	li	a5,1
     36e:	02f50d63          	beq	a0,a5,3a8 <badwrite+0xb8>
    printf("write failed\n");
     372:	00005517          	auipc	a0,0x5
     376:	0ee50513          	addi	a0,a0,238 # 5460 <malloc+0x24a>
     37a:	5e3040ef          	jal	ra,515c <printf>
    exit(1);
     37e:	4505                	li	a0,1
     380:	1b1040ef          	jal	ra,4d30 <exit>
      printf("open junk failed\n");
     384:	00005517          	auipc	a0,0x5
     388:	0c450513          	addi	a0,a0,196 # 5448 <malloc+0x232>
     38c:	5d1040ef          	jal	ra,515c <printf>
      exit(1);
     390:	4505                	li	a0,1
     392:	19f040ef          	jal	ra,4d30 <exit>
    printf("open junk failed\n");
     396:	00005517          	auipc	a0,0x5
     39a:	0b250513          	addi	a0,a0,178 # 5448 <malloc+0x232>
     39e:	5bf040ef          	jal	ra,515c <printf>
    exit(1);
     3a2:	4505                	li	a0,1
  ...
  unlink("junk");
     ...
     3b2:	09250513          	addi	a0,a0,146 # 5440 <malloc+0x22a>
...
0000000000000480 <copyin>:
{
  ...
  uint64 addrs[] = { 0x80000000LL, 0x3fffffe000, 0x3ffffff000, 0x4000000000,
     ...
     496:	3e678793          	addi	a5,a5,998 # 7878 <malloc+0x2662>
     49a:	638c                	ld	a1,0(a5)
     49c:	6790                	ld	a2,8(a5)
  ...
  for(int ai = 0; ai < sizeof(addrs)/sizeof(addrs[0]); ai++){
    ...
    int fd = open("copyin1", O_CREATE|O_WRONLY);
     ...
     4c4:	fb0a0a13          	addi	s4,s4,-80 # 5470 <malloc+0x25a>
    uint64 addr = addrs[ai];
  ...
  for(int ai = 0; ai < sizeof(addrs)/sizeof(addrs[0]); ai++){
     ...
     54a:	f3250513          	addi	a0,a0,-206 # 5478 <malloc+0x262>
     54e:	40f040ef          	jal	ra,515c <printf>
      exit(1);
     552:	4505                	li	a0,1
     ...
     560:	f3450513          	addi	a0,a0,-204 # 5490 <malloc+0x27a>
     564:	3f9040ef          	jal	ra,515c <printf>
      exit(1);
     568:	4505                	li	a0,1
     ...
     576:	f4e50513          	addi	a0,a0,-178 # 54c0 <malloc+0x2aa>
     57a:	3e3040ef          	jal	ra,515c <printf>
      exit(1);
     57e:	4505                	li	a0,1
     580:	7b0040ef          	jal	ra,4d30 <exit>
      printf("pipe() failed\n");
     584:	00005517          	auipc	a0,0x5
     588:	f6c50513          	addi	a0,a0,-148 # 54f0 <malloc+0x2da>
     58c:	3d1040ef          	jal	ra,515c <printf>
      exit(1);
     590:	4505                	li	a0,1
     ...
     59e:	f6650513          	addi	a0,a0,-154 # 5500 <malloc+0x2ea>
     5a2:	3bb040ef          	jal	ra,515c <printf>
      exit(1);
     5a6:	4505                	li	a0,1
...
00000000000005ac <copyout>:
{
  ...
  uint64 addrs[] = { 0LL, 0x80000000LL, 0x3fffffe000, 0x3ffffff000, 0x4000000000,
     ...
     5c4:	2b878793          	addi	a5,a5,696 # 7878 <malloc+0x2662>
  ...
  for(int ai = 0; ai < sizeof(addrs)/sizeof(addrs[0]); ai++){
    ...
    int fd = open("README", 0);
     ...
     5f8:	f3ca0a13          	addi	s4,s4,-196 # 5530 <malloc+0x31a>
    n = write(fds[1], "x", 1);
     5fc:	00005a97          	auipc	s5,0x5
     600:	dcca8a93          	addi	s5,s5,-564 # 53c8 <malloc+0x1b2>
    uint64 addr = addrs[ai];
  ...
  for(int ai = 0; ai < sizeof(addrs)/sizeof(addrs[0]); ai++){
     ...
     684:	eb850513          	addi	a0,a0,-328 # 5538 <malloc+0x322>
     688:	2d5040ef          	jal	ra,515c <printf>
      exit(1);
     68c:	4505                	li	a0,1
     ...
     69a:	eba50513          	addi	a0,a0,-326 # 5550 <malloc+0x33a>
     69e:	2bf040ef          	jal	ra,515c <printf>
      exit(1);
     6a2:	4505                	li	a0,1
     6a4:	68c040ef          	jal	ra,4d30 <exit>
      printf("pipe() failed\n");
     6a8:	00005517          	auipc	a0,0x5
     6ac:	e4850513          	addi	a0,a0,-440 # 54f0 <malloc+0x2da>
     6b0:	2ad040ef          	jal	ra,515c <printf>
      exit(1);
     6b4:	4505                	li	a0,1
     6b6:	67a040ef          	jal	ra,4d30 <exit>
      printf("pipe write failed\n");
     6ba:	00005517          	auipc	a0,0x5
     6be:	ec650513          	addi	a0,a0,-314 # 5580 <malloc+0x36a>
     6c2:	29b040ef          	jal	ra,515c <printf>
      exit(1);
     6c6:	4505                	li	a0,1
     ...
     6d4:	ec850513          	addi	a0,a0,-312 # 5598 <malloc+0x382>
     6d8:	285040ef          	jal	ra,515c <printf>
      exit(1);
     6dc:	4505                	li	a0,1
...
00000000000006e2 <truncate1>:
{
  ...
  int fd2 = open("truncfile", O_RDONLY);
     ...
     72e:	c8650513          	addi	a0,a0,-890 # 53b0 <malloc+0x19a>
  ...
  fd1 = open("truncfile", O_WRONLY|O_TRUNC);
     ...
     752:	c6250513          	addi	a0,a0,-926 # 53b0 <malloc+0x19a>
     756:	61a040ef          	jal	ra,4d70 <open>
     75a:	89aa                	mv	s3,a0
  int fd3 = open("truncfile", O_RDONLY);
     75c:	4581                	li	a1,0
     75e:	00005517          	auipc	a0,0x5
     762:	c5250513          	addi	a0,a0,-942 # 53b0 <malloc+0x19a>
  ...
  write(fd1, "abcdef", 6);
     ...
     794:	e9858593          	addi	a1,a1,-360 # 5628 <malloc+0x412>
     798:	854e                	mv	a0,s3
  ...
  unlink("truncfile");
     ...
     7ca:	bea50513          	addi	a0,a0,-1046 # 53b0 <malloc+0x19a>
  ...
  close(fd3);
    ...
    printf("%s: read %d bytes, wanted 4\n", s, n);
     ...
     7fe:	dce50513          	addi	a0,a0,-562 # 55c8 <malloc+0x3b2>
     802:	15b040ef          	jal	ra,515c <printf>
    exit(1);
     806:	4505                	li	a0,1
    ...
    printf("aaa fd3=%d\n", fd3);
     ...
     812:	dda50513          	addi	a0,a0,-550 # 55e8 <malloc+0x3d2>
     816:	147040ef          	jal	ra,515c <printf>
    printf("%s: read %d bytes, wanted 0\n", s, n);
     81a:	8652                	mv	a2,s4
     81c:	85d6                	mv	a1,s5
     81e:	00005517          	auipc	a0,0x5
     822:	dda50513          	addi	a0,a0,-550 # 55f8 <malloc+0x3e2>
     826:	137040ef          	jal	ra,515c <printf>
    exit(1);
     82a:	4505                	li	a0,1
    ...
    printf("bbb fd2=%d\n", fd2);
     ...
     836:	de650513          	addi	a0,a0,-538 # 5618 <malloc+0x402>
     83a:	123040ef          	jal	ra,515c <printf>
    printf("%s: read %d bytes, wanted 0\n", s, n);
     83e:	8652                	mv	a2,s4
     840:	85d6                	mv	a1,s5
     842:	00005517          	auipc	a0,0x5
     846:	db650513          	addi	a0,a0,-586 # 55f8 <malloc+0x3e2>
     84a:	113040ef          	jal	ra,515c <printf>
    exit(1);
     84e:	4505                	li	a0,1
    ...
    printf("%s: read %d bytes, wanted 6\n", s, n);
     ...
     85c:	dd850513          	addi	a0,a0,-552 # 5630 <malloc+0x41a>
     860:	0fd040ef          	jal	ra,515c <printf>
    exit(1);
     864:	4505                	li	a0,1
    ...
    printf("%s: read %d bytes, wanted 2\n", s, n);
     ...
     872:	de250513          	addi	a0,a0,-542 # 5650 <malloc+0x43a>
     876:	0e7040ef          	jal	ra,515c <printf>
    exit(1);
     87a:	4505                	li	a0,1
...
0000000000000880 <writetest>:
{
  ...
  fd = open("small", O_CREATE|O_RDWR);
     ...
     89e:	dd650513          	addi	a0,a0,-554 # 5670 <malloc+0x45a>
  ...
  if(fd < 0){
    ...
    if(write(fd, "aaaaaaaaaa", SZ) != SZ){
     ...
     8b2:	dea98993          	addi	s3,s3,-534 # 5698 <malloc+0x482>
    if(write(fd, "bbbbbbbbbb", SZ) != SZ){
     8b6:	00005a97          	auipc	s5,0x5
     8ba:	e1aa8a93          	addi	s5,s5,-486 # 56d0 <malloc+0x4ba>
  for(i = 0; i < N; i++){
  ...
  fd = open("small", O_RDONLY);
     ...
     8f4:	d8050513          	addi	a0,a0,-640 # 5670 <malloc+0x45a>
  ...
  if(unlink("small") < 0){
     ...
     924:	d5050513          	addi	a0,a0,-688 # 5670 <malloc+0x45a>
    ...
    printf("%s: error: creat small failed!\n", s);
     ...
     94a:	d3250513          	addi	a0,a0,-718 # 5678 <malloc+0x462>
     94e:	00f040ef          	jal	ra,515c <printf>
    exit(1);
     952:	4505                	li	a0,1
     ...
     960:	d4c50513          	addi	a0,a0,-692 # 56a8 <malloc+0x492>
     964:	7f8040ef          	jal	ra,515c <printf>
      exit(1);
     968:	4505                	li	a0,1
     ...
     976:	d6e50513          	addi	a0,a0,-658 # 56e0 <malloc+0x4ca>
     97a:	7e2040ef          	jal	ra,515c <printf>
      exit(1);
     97e:	4505                	li	a0,1
    ...
    printf("%s: error: open small failed!\n", s);
     ...
     98a:	d8250513          	addi	a0,a0,-638 # 5708 <malloc+0x4f2>
     98e:	7ce040ef          	jal	ra,515c <printf>
    exit(1);
     992:	4505                	li	a0,1
    ...
    printf("%s: read failed\n", s);
     ...
     99e:	d8e50513          	addi	a0,a0,-626 # 5728 <malloc+0x512>
     9a2:	7ba040ef          	jal	ra,515c <printf>
    exit(1);
     9a6:	4505                	li	a0,1
    ...
    printf("%s: unlink small failed\n", s);
     ...
     9b2:	d9250513          	addi	a0,a0,-622 # 5740 <malloc+0x52a>
     9b6:	7a6040ef          	jal	ra,515c <printf>
    exit(1);
     9ba:	4505                	li	a0,1
...
00000000000009c0 <writebig>:
{
  ...
  fd = open("big", O_CREATE|O_RDWR);
     ...
     9dc:	d8850513          	addi	a0,a0,-632 # 5760 <malloc+0x54a>
  ...
  fd = open("big", O_RDONLY);
     ...
     a22:	d4250513          	addi	a0,a0,-702 # 5760 <malloc+0x54a>
  ...
  if(fd < 0){
    ...
    printf("%s: error: creat big failed!\n", s);
     ...
     a62:	d0a50513          	addi	a0,a0,-758 # 5768 <malloc+0x552>
     a66:	6f6040ef          	jal	ra,515c <printf>
    exit(1);
     a6a:	4505                	li	a0,1
     ...
     a78:	d1450513          	addi	a0,a0,-748 # 5788 <malloc+0x572>
     a7c:	6e0040ef          	jal	ra,515c <printf>
      exit(1);
     a80:	4505                	li	a0,1
    ...
    printf("%s: error: open big failed!\n", s);
     ...
     a8c:	d2850513          	addi	a0,a0,-728 # 57b0 <malloc+0x59a>
     a90:	6cc040ef          	jal	ra,515c <printf>
    exit(1);
     a94:	4505                	li	a0,1
  ...
  if(unlink("big") < 0){
     ...
     aac:	cb850513          	addi	a0,a0,-840 # 5760 <malloc+0x54a>
     ...
     ad2:	d0250513          	addi	a0,a0,-766 # 57d0 <malloc+0x5ba>
     ad6:	686040ef          	jal	ra,515c <printf>
        exit(1);
     ada:	4505                	li	a0,1
     ...
     ae8:	d1450513          	addi	a0,a0,-748 # 57f8 <malloc+0x5e2>
     aec:	670040ef          	jal	ra,515c <printf>
      exit(1);
     af0:	4505                	li	a0,1
     ...
     afe:	d1650513          	addi	a0,a0,-746 # 5810 <malloc+0x5fa>
     b02:	65a040ef          	jal	ra,515c <printf>
      exit(1);
     b06:	4505                	li	a0,1
    ...
    printf("%s: unlink big failed\n", s);
     ...
     b12:	d2a50513          	addi	a0,a0,-726 # 5838 <malloc+0x622>
     b16:	646040ef          	jal	ra,515c <printf>
    exit(1);
     b1a:	4505                	li	a0,1
...
0000000000000b20 <unlinkread>:
{
  ...
  fd = open("unlinkread", O_CREATE | O_RDWR);
     ...
     b38:	d1c50513          	addi	a0,a0,-740 # 5850 <malloc+0x63a>
  ...
  write(fd, "hello", SZ);
     ...
     b4c:	d3858593          	addi	a1,a1,-712 # 5880 <malloc+0x66a>
  ...
  fd = open("unlinkread", O_RDWR);
     ...
     b60:	cf450513          	addi	a0,a0,-780 # 5850 <malloc+0x63a>
  ...
  if(unlink("unlinkread") != 0){
     ...
     b72:	ce250513          	addi	a0,a0,-798 # 5850 <malloc+0x63a>
  ...
  fd1 = open("unlinkread", O_CREATE | O_RDWR);
     ...
     b84:	cd050513          	addi	a0,a0,-816 # 5850 <malloc+0x63a>
     b88:	1e8040ef          	jal	ra,4d70 <open>
     b8c:	892a                	mv	s2,a0
  write(fd1, "yyy", 3);
     b8e:	460d                	li	a2,3
     b90:	00005597          	auipc	a1,0x5
     b94:	d3858593          	addi	a1,a1,-712 # 58c8 <malloc+0x6b2>
  ...
  unlink("unlinkread");
     ...
     be8:	c6c50513          	addi	a0,a0,-916 # 5850 <malloc+0x63a>
    ...
    printf("%s: create unlinkread failed\n", s);
     ...
     c04:	c6050513          	addi	a0,a0,-928 # 5860 <malloc+0x64a>
     c08:	554040ef          	jal	ra,515c <printf>
    exit(1);
     c0c:	4505                	li	a0,1
    ...
    printf("%s: open unlinkread failed\n", s);
     ...
     c18:	c7450513          	addi	a0,a0,-908 # 5888 <malloc+0x672>
     c1c:	540040ef          	jal	ra,515c <printf>
    exit(1);
     c20:	4505                	li	a0,1
    ...
    printf("%s: unlink unlinkread failed\n", s);
     ...
     c2c:	c8050513          	addi	a0,a0,-896 # 58a8 <malloc+0x692>
     c30:	52c040ef          	jal	ra,515c <printf>
    exit(1);
     c34:	4505                	li	a0,1
    ...
    printf("%s: unlinkread read failed", s);
     ...
     c40:	c9450513          	addi	a0,a0,-876 # 58d0 <malloc+0x6ba>
     c44:	518040ef          	jal	ra,515c <printf>
    exit(1);
     c48:	4505                	li	a0,1
    ...
    printf("%s: unlinkread wrong data\n", s);
     ...
     c54:	ca050513          	addi	a0,a0,-864 # 58f0 <malloc+0x6da>
     c58:	504040ef          	jal	ra,515c <printf>
    exit(1);
     c5c:	4505                	li	a0,1
    ...
    printf("%s: unlinkread write failed\n", s);
     ...
     c68:	cac50513          	addi	a0,a0,-852 # 5910 <malloc+0x6fa>
     c6c:	4f0040ef          	jal	ra,515c <printf>
    exit(1);
     c70:	4505                	li	a0,1
...
0000000000000c76 <linktest>:
{
  ...
  if(write(fd, "hello", SZ) != SZ){
     ...
     cb8:	bcc58593          	addi	a1,a1,-1076 # 5880 <malloc+0x66a>
  ...
  if(link(".", "lf1") >= 0){
    ...
    printf("%s: create lf1 failed\n", s);
     ...
     d90:	bb450513          	addi	a0,a0,-1100 # 5940 <malloc+0x72a>
     d94:	3c8040ef          	jal	ra,515c <printf>
    exit(1);
     d98:	4505                	li	a0,1
    ...
    printf("%s: write lf1 failed\n", s);
     ...
     da4:	bb850513          	addi	a0,a0,-1096 # 5958 <malloc+0x742>
     da8:	3b4040ef          	jal	ra,515c <printf>
    exit(1);
     dac:	4505                	li	a0,1
    ...
    printf("%s: link lf1 lf2 failed\n", s);
     ...
     db8:	bbc50513          	addi	a0,a0,-1092 # 5970 <malloc+0x75a>
     dbc:	3a0040ef          	jal	ra,515c <printf>
    exit(1);
     dc0:	4505                	li	a0,1
    ...
    printf("%s: unlinked lf1 but it is still there!\n", s);
     ...
     dcc:	bc850513          	addi	a0,a0,-1080 # 5990 <malloc+0x77a>
     dd0:	38c040ef          	jal	ra,515c <printf>
    exit(1);
     dd4:	4505                	li	a0,1
    ...
    printf("%s: open lf2 failed\n", s);
     ...
     de0:	be450513          	addi	a0,a0,-1052 # 59c0 <malloc+0x7aa>
     de4:	378040ef          	jal	ra,515c <printf>
    exit(1);
     de8:	4505                	li	a0,1
    ...
    printf("%s: read lf2 failed\n", s);
     ...
     df4:	be850513          	addi	a0,a0,-1048 # 59d8 <malloc+0x7c2>
     df8:	364040ef          	jal	ra,515c <printf>
    exit(1);
     dfc:	4505                	li	a0,1
    ...
    printf("%s: link lf2 lf2 succeeded! oops\n", s);
     ...
     e08:	bec50513          	addi	a0,a0,-1044 # 59f0 <malloc+0x7da>
     e0c:	350040ef          	jal	ra,515c <printf>
    exit(1);
     e10:	4505                	li	a0,1
    ...
    printf("%s: link non-existent succeeded! oops\n", s);
     ...
     e1c:	c0050513          	addi	a0,a0,-1024 # 5a18 <malloc+0x802>
     e20:	33c040ef          	jal	ra,515c <printf>
    exit(1);
     e24:	4505                	li	a0,1
    ...
    printf("%s: link . lf1 succeeded! oops\n", s);
     ...
     e30:	c1c50513          	addi	a0,a0,-996 # 5a48 <malloc+0x832>
     e34:	328040ef          	jal	ra,515c <printf>
    exit(1);
     e38:	4505                	li	a0,1
...
0000000000000e3e <validatetest>:
{
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    if(link("nosuchfile", (char*)p) != -1){
     ...
     e5a:	c1298993          	addi	s3,s3,-1006 # 5a68 <malloc+0x852>
     e5e:	597d                	li	s2,-1
  for(p = 0; p <= (uint)hi; p += PGSIZE){
     e60:	6a85                	lui	s5,0x1
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
     ...
     e92:	bea50513          	addi	a0,a0,-1046 # 5a78 <malloc+0x862>
     e96:	2c6040ef          	jal	ra,515c <printf>
      exit(1);
     e9a:	4505                	li	a0,1
...
0000000000000ea0 <bigdir>:
{
  ...
  unlink("bd");
     ...
     eba:	be250513          	addi	a0,a0,-1054 # 5a98 <malloc+0x882>
     ebe:	6c3030ef          	jal	ra,4d80 <unlink>
  fd = open("bd", O_CREATE);
     ec2:	20000593          	li	a1,512
     ec6:	00005517          	auipc	a0,0x5
     eca:	bd250513          	addi	a0,a0,-1070 # 5a98 <malloc+0x882>
  ...
  for(i = 0; i < N; i++){
    ...
    if(link("bd", name) != 0){
     ...
     ee4:	bb8a0a13          	addi	s4,s4,-1096 # 5a98 <malloc+0x882>
  for(i = 0; i < N; i++){
  ...
  unlink("bd");
     ...
     f32:	b6a50513          	addi	a0,a0,-1174 # 5a98 <malloc+0x882>
  ...
  for(i = 0; i < N; i++){
    ...
    printf("%s: bigdir create failed\n", s);
     ...
     f9a:	b0a50513          	addi	a0,a0,-1270 # 5aa0 <malloc+0x88a>
     f9e:	1be040ef          	jal	ra,515c <printf>
    exit(1);
     fa2:	4505                	li	a0,1
     ...
     fb4:	b1050513          	addi	a0,a0,-1264 # 5ac0 <malloc+0x8aa>
     fb8:	1a4040ef          	jal	ra,515c <printf>
      exit(1);
     fbc:	4505                	li	a0,1
     ...
     fc8:	b2450513          	addi	a0,a0,-1244 # 5ae8 <malloc+0x8d2>
     fcc:	190040ef          	jal	ra,515c <printf>
      exit(1);
     fd0:	4505                	li	a0,1
...
0000000000001002 <badarg>:
{
    ...
    1020:	33c98993          	addi	s3,s3,828 # 5358 <malloc+0x142>
    argv[0] = (char*)0xffffffff;
...
0000000000001040 <copyinstr2>:
{
  ...
  char *args[] = { "xx", 0 };
    ...
    1096:	ba678793          	addi	a5,a5,-1114 # 6c38 <malloc+0x1a22>
  ...
  if(pid == 0){
    ...
    10ea:	79278793          	addi	a5,a5,1938 # 7878 <malloc+0x2662>
    ...
    110e:	24e50513          	addi	a0,a0,590 # 5358 <malloc+0x142>
    ...
    1122:	a7250513          	addi	a0,a0,-1422 # 5b90 <malloc+0x97a>
    1126:	036040ef          	jal	ra,515c <printf>
      exit(1);
    112a:	4505                	li	a0,1
    ...
    113a:	9d250513          	addi	a0,a0,-1582 # 5b08 <malloc+0x8f2>
    113e:	01e040ef          	jal	ra,515c <printf>
    exit(1);
    1142:	4505                	li	a0,1
    ...
    1152:	9da50513          	addi	a0,a0,-1574 # 5b28 <malloc+0x912>
    1156:	006040ef          	jal	ra,515c <printf>
    exit(1);
    115a:	4505                	li	a0,1
    ...
    116c:	9e050513          	addi	a0,a0,-1568 # 5b48 <malloc+0x932>
    1170:	7ed030ef          	jal	ra,515c <printf>
    exit(1);
    1174:	4505                	li	a0,1
    ...
    1184:	9f050513          	addi	a0,a0,-1552 # 5b70 <malloc+0x95a>
    1188:	7d5030ef          	jal	ra,515c <printf>
    exit(1);
    118c:	4505                	li	a0,1
    118e:	3a3030ef          	jal	ra,4d30 <exit>
    printf("fork failed\n");
    1192:	00006517          	auipc	a0,0x6
    1196:	fde50513          	addi	a0,a0,-34 # 7170 <malloc+0x1f5a>
    119a:	7c3030ef          	jal	ra,515c <printf>
    exit(1);
    119e:	4505                	li	a0,1
  ...
  if(st != 747){
    ...
    11d0:	9ec50513          	addi	a0,a0,-1556 # 5bb8 <malloc+0x9a2>
    11d4:	789030ef          	jal	ra,515c <printf>
    exit(1);
    11d8:	4505                	li	a0,1
...
00000000000011de <truncate3>:
{
  ...
  close(open("truncfile", O_CREATE|O_TRUNC|O_WRONLY));
    ...
    11fa:	1ba50513          	addi	a0,a0,442 # 53b0 <malloc+0x19a>
  ...
  if(pid == 0){
    ...
    1218:	19ca0a13          	addi	s4,s4,412 # 53b0 <malloc+0x19a>
      int n = write(fd, "1234567890", 10);
    121c:	00005a97          	auipc	s5,0x5
    1220:	9fca8a93          	addi	s5,s5,-1540 # 5c18 <malloc+0xa02>
      int fd = open("truncfile", O_WRONLY);
    1224:	4585                	li	a1,1
    1226:	8552                	mv	a0,s4
    ...
    1274:	97850513          	addi	a0,a0,-1672 # 5be8 <malloc+0x9d2>
    1278:	6e5030ef          	jal	ra,515c <printf>
    exit(1);
    127c:	4505                	li	a0,1
    ...
    1288:	97c50513          	addi	a0,a0,-1668 # 5c00 <malloc+0x9ea>
    128c:	6d1030ef          	jal	ra,515c <printf>
        exit(1);
    1290:	4505                	li	a0,1
    ...
    129e:	98e50513          	addi	a0,a0,-1650 # 5c28 <malloc+0xa12>
    12a2:	6bb030ef          	jal	ra,515c <printf>
        exit(1);
    12a6:	4505                	li	a0,1
    ...
    12b4:	100a0a13          	addi	s4,s4,256 # 53b0 <malloc+0x19a>
    int n = write(fd, "xxx", 3);
    12b8:	00005a97          	auipc	s5,0x5
    12bc:	990a8a93          	addi	s5,s5,-1648 # 5c48 <malloc+0xa32>
    int fd = open("truncfile", O_CREATE|O_WRONLY|O_TRUNC);
  ...
  unlink("truncfile");
    ...
    12f6:	0be50513          	addi	a0,a0,190 # 53b0 <malloc+0x19a>
  ...
  exit(xstatus);
    ...
    130c:	8f850513          	addi	a0,a0,-1800 # 5c00 <malloc+0x9ea>
    1310:	64d030ef          	jal	ra,515c <printf>
      exit(1);
    1314:	4505                	li	a0,1
    ...
    1322:	93250513          	addi	a0,a0,-1742 # 5c50 <malloc+0xa3a>
    1326:	637030ef          	jal	ra,515c <printf>
      exit(1);
    132a:	4505                	li	a0,1
...
0000000000001330 <exectest>:
{
  ...
  char *echoargv[] = { "echo", "OK", 0 };
    ...
    1342:	01a78793          	addi	a5,a5,26 # 5358 <malloc+0x142>
    1346:	fcf43023          	sd	a5,-64(s0)
    134a:	00005797          	auipc	a5,0x5
    134e:	92678793          	addi	a5,a5,-1754 # 5c70 <malloc+0xa5a>
    1352:	fcf43423          	sd	a5,-56(s0)
    1356:	fc043823          	sd	zero,-48(s0)
  unlink("echo-ok");
    135a:	00005517          	auipc	a0,0x5
    135e:	91e50513          	addi	a0,a0,-1762 # 5c78 <malloc+0xa62>
  ...
  if(pid == 0) {
    ...
    1380:	8fc50513          	addi	a0,a0,-1796 # 5c78 <malloc+0xa62>
    ...
    1398:	90450513          	addi	a0,a0,-1788 # 5c98 <malloc+0xa82>
    139c:	5c1030ef          	jal	ra,515c <printf>
      exit(1);
    13a0:	4505                	li	a0,1
    ...
    13ac:	84050513          	addi	a0,a0,-1984 # 5be8 <malloc+0x9d2>
    13b0:	5ad030ef          	jal	ra,515c <printf>
     exit(1);
    13b4:	4505                	li	a0,1
    ...
    13c0:	8c450513          	addi	a0,a0,-1852 # 5c80 <malloc+0xa6a>
    13c4:	599030ef          	jal	ra,515c <printf>
      exit(1);
    13c8:	4505                	li	a0,1
    ...
    13d6:	f8650513          	addi	a0,a0,-122 # 5358 <malloc+0x142>
  ...
  if(xstatus != 0)
    ...
    13fe:	8ae50513          	addi	a0,a0,-1874 # 5ca8 <malloc+0xa92>
    1402:	55b030ef          	jal	ra,515c <printf>
      exit(1);
    1406:	4505                	li	a0,1
    ...
    1412:	8b250513          	addi	a0,a0,-1870 # 5cc0 <malloc+0xaaa>
    1416:	547030ef          	jal	ra,515c <printf>
    141a:	bfd1                	j	13ee <exectest+0xbe>
  fd = open("echo-ok", O_RDONLY);
    141c:	4581                	li	a1,0
    141e:	00005517          	auipc	a0,0x5
    1422:	85a50513          	addi	a0,a0,-1958 # 5c78 <malloc+0xa62>
  ...
  if (read(fd, buf, 2) != 2) {
    ...
    1444:	2e850513          	addi	a0,a0,744 # 5728 <malloc+0x512>
    1448:	515030ef          	jal	ra,515c <printf>
    exit(1);
    144c:	4505                	li	a0,1
    ...
    1458:	7ac50513          	addi	a0,a0,1964 # 5c00 <malloc+0x9ea>
    145c:	501030ef          	jal	ra,515c <printf>
    exit(1);
    1460:	4505                	li	a0,1
    1462:	0cf030ef          	jal	ra,4d30 <exit>
  unlink("echo-ok");
    1466:	00005517          	auipc	a0,0x5
    146a:	81250513          	addi	a0,a0,-2030 # 5c78 <malloc+0xa62>
  ...
  if(buf[0] == 'O' && buf[1] == 'K')
    ...
    1490:	84c50513          	addi	a0,a0,-1972 # 5cd8 <malloc+0xac2>
    1494:	4c9030ef          	jal	ra,515c <printf>
    exit(1);
    1498:	4505                	li	a0,1
...
00000000000014a4 <pipe1>:
{
  ...
  if(pid == 0){
    ...
    1536:	7be50513          	addi	a0,a0,1982 # 5cf0 <malloc+0xada>
    153a:	423030ef          	jal	ra,515c <printf>
    exit(1);
    153e:	4505                	li	a0,1
    ...
    1564:	42da8a93          	addi	s5,s5,1069 # 142d <exectest+0xfd>
{
    ...
    15a8:	76450513          	addi	a0,a0,1892 # 5d08 <malloc+0xaf2>
    15ac:	3b1030ef          	jal	ra,515c <printf>
        exit(1);
    15b0:	4505                	li	a0,1
    ...
    15bc:	76850513          	addi	a0,a0,1896 # 5d20 <malloc+0xb0a>
    15c0:	39d030ef          	jal	ra,515c <printf>
}
    ...
    15ec:	75050513          	addi	a0,a0,1872 # 5d38 <malloc+0xb22>
    15f0:	36d030ef          	jal	ra,515c <printf>
      exit(1);
    15f4:	4505                	li	a0,1
    ...
    1618:	74450513          	addi	a0,a0,1860 # 5d58 <malloc+0xb42>
    161c:	341030ef          	jal	ra,515c <printf>
    exit(1);
    1620:	4505                	li	a0,1
...
0000000000001626 <exitwait>:
{
  ...
  for(i = 0; i < 100; i++){
    ...
    167a:	57250513          	addi	a0,a0,1394 # 5be8 <malloc+0x9d2>
    167e:	2df030ef          	jal	ra,515c <printf>
      exit(1);
    1682:	4505                	li	a0,1
    ...
    168e:	6e650513          	addi	a0,a0,1766 # 5d70 <malloc+0xb5a>
    1692:	2cb030ef          	jal	ra,515c <printf>
        exit(1);
    1696:	4505                	li	a0,1
    ...
    16a2:	6ea50513          	addi	a0,a0,1770 # 5d88 <malloc+0xb72>
    16a6:	2b7030ef          	jal	ra,515c <printf>
        exit(1);
    16aa:	4505                	li	a0,1
...
00000000000016b6 <twochildren>:
{
  ...
  for(int i = 0; i < 1000; i++){
    ...
    16fe:	4ee50513          	addi	a0,a0,1262 # 5be8 <malloc+0x9d2>
    1702:	25b030ef          	jal	ra,515c <printf>
      exit(1);
    1706:	4505                	li	a0,1
    ...
    1716:	4d650513          	addi	a0,a0,1238 # 5be8 <malloc+0x9d2>
    171a:	243030ef          	jal	ra,515c <printf>
        exit(1);
    171e:	4505                	li	a0,1
...
0000000000001728 <forkfork>:
{
    ...
    1774:	63850513          	addi	a0,a0,1592 # 5da8 <malloc+0xb92>
    1778:	1e5030ef          	jal	ra,515c <printf>
      exit(1);
    177c:	4505                	li	a0,1
    177e:	5b2030ef          	jal	ra,4d30 <exit>
{
    ...
    17b0:	60c50513          	addi	a0,a0,1548 # 5db8 <malloc+0xba2>
    17b4:	1a9030ef          	jal	ra,515c <printf>
      exit(1);
    17b8:	4505                	li	a0,1
...
00000000000017be <reparent2>:
{
  ...
  exit(0);
    ...
    17ea:	98a50513          	addi	a0,a0,-1654 # 7170 <malloc+0x1f5a>
    17ee:	16f030ef          	jal	ra,515c <printf>
      exit(1);
    17f2:	4505                	li	a0,1
...
0000000000001806 <createdelete>:
{
  ...
  name[0] = name[1] = name[2] = 0;
    ...
    186c:	38050513          	addi	a0,a0,896 # 5be8 <malloc+0x9d2>
    1870:	0ed030ef          	jal	ra,515c <printf>
      exit(1);
    1874:	4505                	li	a0,1
    ...
    1890:	3f450513          	addi	a0,a0,1012 # 5c80 <malloc+0xa6a>
    1894:	0c9030ef          	jal	ra,515c <printf>
          exit(1);
    1898:	4505                	li	a0,1
    ...
    18ee:	4ee50513          	addi	a0,a0,1262 # 5dd8 <malloc+0xbc2>
    18f2:	06b030ef          	jal	ra,515c <printf>
            exit(1);
    18f6:	4505                	li	a0,1
    ...
    1912:	4e250513          	addi	a0,a0,1250 # 5df0 <malloc+0xbda>
    1916:	047030ef          	jal	ra,515c <printf>
        exit(1);
    191a:	4505                	li	a0,1
    ...
    1968:	4b450513          	addi	a0,a0,1204 # 5e18 <malloc+0xc02>
    196c:	7f0030ef          	jal	ra,515c <printf>
        exit(1);
    1970:	4505                	li	a0,1
...
00000000000019de <linkunlink>:
{
  ...
  unlink("x");
    ...
    19fe:	9ce50513          	addi	a0,a0,-1586 # 53c8 <malloc+0x1b2>
  ...
  unsigned int x = (pid ? 1 : 97);
    ...
    1a32:	99aa8a93          	addi	s5,s5,-1638 # 53c8 <malloc+0x1b2>
      link("cat", "x");
    1a36:	00004b97          	auipc	s7,0x4
    1a3a:	40ab8b93          	addi	s7,s7,1034 # 5e40 <malloc+0xc2a>
    1a3e:	a025                	j	1a66 <linkunlink+0x88>
    printf("%s: fork failed\n", s);
    1a40:	85a6                	mv	a1,s1
    1a42:	00004517          	auipc	a0,0x4
    1a46:	1a650513          	addi	a0,a0,422 # 5be8 <malloc+0x9d2>
    1a4a:	712030ef          	jal	ra,515c <printf>
    exit(1);
    1a4e:	4505                	li	a0,1
...
0000000000001ab8 <forktest>:
{
  ...
  for(n=0; n<N; n++){
    ...
    1ae4:	38050513          	addi	a0,a0,896 # 5e60 <malloc+0xc4a>
    1ae8:	674030ef          	jal	ra,515c <printf>
    exit(1);
    1aec:	4505                	li	a0,1
  ...
  if(wait(0) != -1){
    ...
    1b32:	31a50513          	addi	a0,a0,794 # 5e48 <malloc+0xc32>
    1b36:	626030ef          	jal	ra,515c <printf>
    exit(1);
    1b3a:	4505                	li	a0,1
    ...
    1b46:	34650513          	addi	a0,a0,838 # 5e88 <malloc+0xc72>
    1b4a:	612030ef          	jal	ra,515c <printf>
      exit(1);
    1b4e:	4505                	li	a0,1
    ...
    1b5a:	34a50513          	addi	a0,a0,842 # 5ea0 <malloc+0xc8a>
    1b5e:	5fe030ef          	jal	ra,515c <printf>
    exit(1);
    1b62:	4505                	li	a0,1
...
0000000000001b68 <kernmem>:
{
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    1bca:	02250513          	addi	a0,a0,34 # 5be8 <malloc+0x9d2>
    1bce:	58e030ef          	jal	ra,515c <printf>
      exit(1);
    1bd2:	4505                	li	a0,1
    ...
    1be4:	2d850513          	addi	a0,a0,728 # 5eb8 <malloc+0xca2>
    1be8:	574030ef          	jal	ra,515c <printf>
      exit(1);
    1bec:	4505                	li	a0,1
...
0000000000001bf8 <MAXVAplus>:
{
  ...
  for( ; a != 0; a <<= 1){
    ...
    1c52:	f9a50513          	addi	a0,a0,-102 # 5be8 <malloc+0x9d2>
    1c56:	506030ef          	jal	ra,515c <printf>
      exit(1);
    1c5a:	4505                	li	a0,1
    ...
    1c76:	26650513          	addi	a0,a0,614 # 5ed8 <malloc+0xcc2>
    1c7a:	4e2030ef          	jal	ra,515c <printf>
      exit(1);
    1c7e:	4505                	li	a0,1
...
r_sp()
{
  ...
  asm volatile("mv %0, sp" : "=r" (x) );
    ...
    1cc6:	22e50513          	addi	a0,a0,558 # 5ef0 <malloc+0xcda>
    1cca:	492030ef          	jal	ra,515c <printf>
    exit(1);
    1cce:	4505                	li	a0,1
    ...
    1cda:	f1250513          	addi	a0,a0,-238 # 5be8 <malloc+0x9d2>
    1cde:	47e030ef          	jal	ra,515c <printf>
    exit(1);
    1ce2:	4505                	li	a0,1
...
0000000000001cee <nowrite>:
{
  ...
  uint64 addrs[] = { 0, 0x80000000LL, 0x3fffffe000, 0x3ffffff000, 0x4000000000,
    ...
    1d02:	b7a78793          	addi	a5,a5,-1158 # 7878 <malloc+0x2662>
  ...
  exit(0);
    ...
    1d68:	1b450513          	addi	a0,a0,436 # 5f18 <malloc+0xd02>
    1d6c:	3f0030ef          	jal	ra,515c <printf>
      exit(0);
    1d70:	4501                	li	a0,0
    ...
    1d7c:	e7050513          	addi	a0,a0,-400 # 5be8 <malloc+0x9d2>
    1d80:	3dc030ef          	jal	ra,515c <printf>
      exit(1);
    1d84:	4505                	li	a0,1
...
0000000000001d90 <manywrites>:
{
  ...
  exit(0);
    ...
    1de0:	39450513          	addi	a0,a0,916 # 7170 <malloc+0x1f5a>
    1de4:	378030ef          	jal	ra,515c <printf>
      exit(1);
    1de8:	4505                	li	a0,1
    ...
    1e6c:	0d050513          	addi	a0,a0,208 # 5f38 <malloc+0xd22>
    1e70:	2ec030ef          	jal	ra,515c <printf>
            exit(1);
    1e74:	4505                	li	a0,1
    ...
    1e84:	5a850513          	addi	a0,a0,1448 # 5428 <malloc+0x212>
    1e88:	2d4030ef          	jal	ra,515c <printf>
            exit(1);
    1e8c:	4505                	li	a0,1
...
0000000000001e96 <copyinstr3>:
{
  ...
  *b = 'x';
  ...
  char *args[] = { "xx", 0 };
    ...
    1ef8:	d4478793          	addi	a5,a5,-700 # 6c38 <malloc+0x1a22>
  ...
  if(ret != -1){
    ...
    1f32:	02250513          	addi	a0,a0,34 # 5f50 <malloc+0xd3a>
    1f36:	226030ef          	jal	ra,515c <printf>
    exit(1);
    1f3a:	4505                	li	a0,1
    ...
    1f48:	bc450513          	addi	a0,a0,-1084 # 5b08 <malloc+0x8f2>
    1f4c:	210030ef          	jal	ra,515c <printf>
    exit(1);
    1f50:	4505                	li	a0,1
    ...
    1f5e:	bce50513          	addi	a0,a0,-1074 # 5b28 <malloc+0x912>
    1f62:	1fa030ef          	jal	ra,515c <printf>
    exit(1);
    1f66:	4505                	li	a0,1
    ...
    1f76:	bd650513          	addi	a0,a0,-1066 # 5b48 <malloc+0x932>
    1f7a:	1e2030ef          	jal	ra,515c <printf>
    exit(1);
    1f7e:	4505                	li	a0,1
    ...
    1f8c:	be850513          	addi	a0,a0,-1048 # 5b70 <malloc+0x95a>
    1f90:	1cc030ef          	jal	ra,515c <printf>
    exit(1);
    1f94:	4505                	li	a0,1
...
0000000000001f9a <rwsbrk>:
{
  ...
  fd = open("rwsbrk", O_CREATE|O_WRONLY);
    ...
    1fc8:	fcc50513          	addi	a0,a0,-52 # 5f90 <malloc+0xd7a>
  ...
  if(n >= 0){
    ...
    1ff2:	fc250513          	addi	a0,a0,-62 # 5fb0 <malloc+0xd9a>
    1ff6:	166030ef          	jal	ra,515c <printf>
    exit(1);
    1ffa:	4505                	li	a0,1
    1ffc:	535020ef          	jal	ra,4d30 <exit>
    printf("sbrk(rwsbrk) failed\n");
    2000:	00004517          	auipc	a0,0x4
    2004:	f5850513          	addi	a0,a0,-168 # 5f58 <malloc+0xd42>
    2008:	154030ef          	jal	ra,515c <printf>
    exit(1);
    200c:	4505                	li	a0,1
    200e:	523020ef          	jal	ra,4d30 <exit>
    printf("sbrk(rwsbrk) shrink failed\n");
    2012:	00004517          	auipc	a0,0x4
    2016:	f5e50513          	addi	a0,a0,-162 # 5f70 <malloc+0xd5a>
    201a:	142030ef          	jal	ra,515c <printf>
    exit(1);
    201e:	4505                	li	a0,1
    2020:	511020ef          	jal	ra,4d30 <exit>
    printf("open(rwsbrk) failed\n");
    2024:	00004517          	auipc	a0,0x4
    2028:	f7450513          	addi	a0,a0,-140 # 5f98 <malloc+0xd82>
    202c:	130030ef          	jal	ra,515c <printf>
    exit(1);
    2030:	4505                	li	a0,1
  ...
  unlink("rwsbrk");
    ...
    2040:	f5450513          	addi	a0,a0,-172 # 5f90 <malloc+0xd7a>
    2044:	53d020ef          	jal	ra,4d80 <unlink>
  fd = open("README", O_RDONLY);
    2048:	4581                	li	a1,0
    204a:	00003517          	auipc	a0,0x3
    204e:	4e650513          	addi	a0,a0,1254 # 5530 <malloc+0x31a>
  ...
  if(n >= 0){
    ...
    2070:	f7450513          	addi	a0,a0,-140 # 5fe0 <malloc+0xdca>
    2074:	0e8030ef          	jal	ra,515c <printf>
    exit(1);
    2078:	4505                	li	a0,1
    207a:	4b7020ef          	jal	ra,4d30 <exit>
    printf("open(README) failed\n");
    207e:	00003517          	auipc	a0,0x3
    2082:	4ba50513          	addi	a0,a0,1210 # 5538 <malloc+0x322>
    2086:	0d6030ef          	jal	ra,515c <printf>
    exit(1);
    208a:	4505                	li	a0,1
...
000000000000209c <sbrkbasic>:
{
  ...
  if(pid == 0){
    ...
    20e6:	f2650513          	addi	a0,a0,-218 # 6008 <malloc+0xdf2>
    20ea:	072030ef          	jal	ra,515c <printf>
    exit(1);
    20ee:	4505                	li	a0,1
  ...
  for(i = 0; i < 5000; i++){
    ...
    2124:	f0850513          	addi	a0,a0,-248 # 6028 <malloc+0xe12>
    2128:	034030ef          	jal	ra,515c <printf>
    exit(1);
    212c:	4505                	li	a0,1
  ...
  if(c != a + 1){
    ...
    2170:	f1c50513          	addi	a0,a0,-228 # 6088 <malloc+0xe72>
    2174:	7e9020ef          	jal	ra,515c <printf>
    exit(1);
    2178:	4505                	li	a0,1
    ...
    218a:	ec250513          	addi	a0,a0,-318 # 6048 <malloc+0xe32>
    218e:	7cf020ef          	jal	ra,515c <printf>
      exit(1);
    2192:	4505                	li	a0,1
    ...
    219e:	ece50513          	addi	a0,a0,-306 # 6068 <malloc+0xe52>
    21a2:	7bb020ef          	jal	ra,515c <printf>
    exit(1);
    21a6:	4505                	li	a0,1
...
00000000000021c6 <sbrkmuch>:
{
  ...
  *lastaddr = 99;
  ...
  if(c != a){
    ...
    2286:	e2650513          	addi	a0,a0,-474 # 60a8 <malloc+0xe92>
    228a:	6d3020ef          	jal	ra,515c <printf>
    exit(1);
    228e:	4505                	li	a0,1
    ...
    229a:	e5a50513          	addi	a0,a0,-422 # 60f0 <malloc+0xeda>
    229e:	6bf020ef          	jal	ra,515c <printf>
    exit(1);
    22a2:	4505                	li	a0,1
    ...
    22b2:	e6250513          	addi	a0,a0,-414 # 6110 <malloc+0xefa>
    22b6:	6a7020ef          	jal	ra,515c <printf>
    exit(1);
    22ba:	4505                	li	a0,1
    ...
    22ca:	e8a50513          	addi	a0,a0,-374 # 6150 <malloc+0xf3a>
    22ce:	68f020ef          	jal	ra,515c <printf>
    exit(1);
    22d2:	4505                	li	a0,1
    ...
    22de:	ea650513          	addi	a0,a0,-346 # 6180 <malloc+0xf6a>
    22e2:	67b020ef          	jal	ra,515c <printf>
    exit(1);
    22e6:	4505                	li	a0,1
    ...
    22f6:	ec650513          	addi	a0,a0,-314 # 61b8 <malloc+0xfa2>
    22fa:	663020ef          	jal	ra,515c <printf>
    exit(1);
    22fe:	4505                	li	a0,1
...
0000000000002304 <sbrkarg>:
{
  ...
  fd = open("sbrk", O_CREATE|O_WRONLY);
    ...
    2324:	ec050513          	addi	a0,a0,-320 # 61e0 <malloc+0xfca>
    2328:	249020ef          	jal	ra,4d70 <open>
    232c:	84aa                	mv	s1,a0
  unlink("sbrk");
    232e:	00004517          	auipc	a0,0x4
    2332:	eb250513          	addi	a0,a0,-334 # 61e0 <malloc+0xfca>
  ...
  if(pipe((int *) a) != 0){
    ...
    2372:	e7a50513          	addi	a0,a0,-390 # 61e8 <malloc+0xfd2>
    2376:	5e7020ef          	jal	ra,515c <printf>
    exit(1);
    237a:	4505                	li	a0,1
    ...
    2386:	e7e50513          	addi	a0,a0,-386 # 6200 <malloc+0xfea>
    238a:	5d3020ef          	jal	ra,515c <printf>
    exit(1);
    238e:	4505                	li	a0,1
    ...
    239a:	95a50513          	addi	a0,a0,-1702 # 5cf0 <malloc+0xada>
    239e:	5bf020ef          	jal	ra,515c <printf>
    exit(1);
    23a2:	4505                	li	a0,1
...
00000000000023a8 <argptest>:
{
  ...
  fd = open("init", O_RDONLY);
    ...
    23bc:	e6050513          	addi	a0,a0,-416 # 6218 <malloc+0x1002>
  ...
  close(fd);
    ...
    23f4:	81050513          	addi	a0,a0,-2032 # 5c00 <malloc+0x9ea>
    23f8:	565020ef          	jal	ra,515c <printf>
    exit(1);
    23fc:	4505                	li	a0,1
...
0000000000002402 <sbrkbugs>:
{
  ...
  if(pid == 0){
    ...
    242a:	d4a50513          	addi	a0,a0,-694 # 7170 <malloc+0x1f5a>
    242e:	52f020ef          	jal	ra,515c <printf>
    exit(1);
    2432:	4505                	li	a0,1
  ...
  if(pid == 0){
    ...
    2464:	d1050513          	addi	a0,a0,-752 # 7170 <malloc+0x1f5a>
    2468:	4f5020ef          	jal	ra,515c <printf>
    exit(1);
    246c:	4505                	li	a0,1
  ...
  if(pid == 0){
    ...
    24a4:	cd050513          	addi	a0,a0,-816 # 7170 <malloc+0x1f5a>
    24a8:	4b5020ef          	jal	ra,515c <printf>
    exit(1);
    24ac:	4505                	li	a0,1
...
000000000000258e <execout>:
{
  ...
  exit(0);
    ...
    25c4:	bb050513          	addi	a0,a0,-1104 # 7170 <malloc+0x1f5a>
    25c8:	395020ef          	jal	ra,515c <printf>
      exit(1);
    25cc:	4505                	li	a0,1
    ...
    2604:	d5850513          	addi	a0,a0,-680 # 5358 <malloc+0x142>
    2608:	faa43c23          	sd	a0,-72(s0)
    260c:	00003797          	auipc	a5,0x3
    2610:	dbc78793          	addi	a5,a5,-580 # 53c8 <malloc+0x1b2>
...
000000000000262a <fourteen>:
{
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    265a:	c4a50513          	addi	a0,a0,-950 # 62a0 <malloc+0x108a>
  ...
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    ...
    2670:	cac50513          	addi	a0,a0,-852 # 6318 <malloc+0x1102>
  ...
  unlink("12345678901234");
    ...
    26f4:	b3050513          	addi	a0,a0,-1232 # 6220 <malloc+0x100a>
    26f8:	265020ef          	jal	ra,515c <printf>
    exit(1);
    26fc:	4505                	li	a0,1
    ...
    2708:	b6450513          	addi	a0,a0,-1180 # 6268 <malloc+0x1052>
    270c:	251020ef          	jal	ra,515c <printf>
    exit(1);
    2710:	4505                	li	a0,1
    ...
    271c:	bb850513          	addi	a0,a0,-1096 # 62d0 <malloc+0x10ba>
    2720:	23d020ef          	jal	ra,515c <printf>
    exit(1);
    2724:	4505                	li	a0,1
    ...
    2730:	c1c50513          	addi	a0,a0,-996 # 6348 <malloc+0x1132>
    2734:	229020ef          	jal	ra,515c <printf>
    exit(1);
    2738:	4505                	li	a0,1
    ...
    2744:	c6850513          	addi	a0,a0,-920 # 63a8 <malloc+0x1192>
    2748:	215020ef          	jal	ra,515c <printf>
    exit(1);
    274c:	4505                	li	a0,1
    ...
    2758:	cac50513          	addi	a0,a0,-852 # 6400 <malloc+0x11ea>
    275c:	201020ef          	jal	ra,515c <printf>
    exit(1);
    2760:	4505                	li	a0,1
...
0000000000002766 <diskfull>:
{
  ...
  unlink("diskfulldir");
    ...
    27a0:	c9c50513          	addi	a0,a0,-868 # 6438 <malloc+0x1222>
  ...
  for(fi = 0; done == 0 && '0' + fi < 0177; fi++){
    ...
    27cc:	c8050513          	addi	a0,a0,-896 # 6448 <malloc+0x1232>
    27d0:	18d020ef          	jal	ra,515c <printf>
      break;
  ...
  for(fi = 0; done == 0 && '0' + fi < 0177; fi++){
    ...
    2970:	afc50513          	addi	a0,a0,-1284 # 6468 <malloc+0x1252>
    2974:	7e8020ef          	jal	ra,515c <printf>
...
000000000000297a <iputtest>:
{
  ...
  if(chdir("/") < 0){
    ...
    29d6:	ace50513          	addi	a0,a0,-1330 # 64a0 <malloc+0x128a>
    29da:	782020ef          	jal	ra,515c <printf>
    exit(1);
    29de:	4505                	li	a0,1
    ...
    29ea:	ad250513          	addi	a0,a0,-1326 # 64b8 <malloc+0x12a2>
    29ee:	76e020ef          	jal	ra,515c <printf>
    exit(1);
    29f2:	4505                	li	a0,1
    ...
    29fe:	aee50513          	addi	a0,a0,-1298 # 64e8 <malloc+0x12d2>
    2a02:	75a020ef          	jal	ra,515c <printf>
    exit(1);
    2a06:	4505                	li	a0,1
    ...
    2a12:	b0250513          	addi	a0,a0,-1278 # 6510 <malloc+0x12fa>
    2a16:	746020ef          	jal	ra,515c <printf>
    exit(1);
    2a1a:	4505                	li	a0,1
...
0000000000002a20 <exitiputtest>:
{
  ...
  if(pid == 0){
    ...
    2a72:	17a50513          	addi	a0,a0,378 # 5be8 <malloc+0x9d2>
    2a76:	6e6020ef          	jal	ra,515c <printf>
    exit(1);
    2a7a:	4505                	li	a0,1
    ...
    2a86:	a1e50513          	addi	a0,a0,-1506 # 64a0 <malloc+0x128a>
    2a8a:	6d2020ef          	jal	ra,515c <printf>
      exit(1);
    2a8e:	4505                	li	a0,1
    ...
    2a9a:	a9250513          	addi	a0,a0,-1390 # 6528 <malloc+0x1312>
    2a9e:	6be020ef          	jal	ra,515c <printf>
      exit(1);
    2aa2:	4505                	li	a0,1
    ...
    2aae:	a3e50513          	addi	a0,a0,-1474 # 64e8 <malloc+0x12d2>
    2ab2:	6aa020ef          	jal	ra,515c <printf>
      exit(1);
    2ab6:	4505                	li	a0,1
...
0000000000002acc <dirtest>:
{
  ...
  if(unlink("dir0") < 0){
    ...
    2b28:	97c50513          	addi	a0,a0,-1668 # 64a0 <malloc+0x128a>
    2b2c:	630020ef          	jal	ra,515c <printf>
    exit(1);
    2b30:	4505                	li	a0,1
    ...
    2b3c:	a1050513          	addi	a0,a0,-1520 # 6548 <malloc+0x1332>
    2b40:	61c020ef          	jal	ra,515c <printf>
    exit(1);
    2b44:	4505                	li	a0,1
    ...
    2b50:	a1c50513          	addi	a0,a0,-1508 # 6568 <malloc+0x1352>
    2b54:	608020ef          	jal	ra,515c <printf>
    exit(1);
    2b58:	4505                	li	a0,1
    ...
    2b64:	a2050513          	addi	a0,a0,-1504 # 6580 <malloc+0x136a>
    2b68:	5f4020ef          	jal	ra,515c <printf>
    exit(1);
    2b6c:	4505                	li	a0,1
...
0000000000002b72 <subdir>:
{
  ...
  unlink("ff");
    ...
    2b84:	b4850513          	addi	a0,a0,-1208 # 66c8 <malloc+0x14b2>
    2b88:	1f8020ef          	jal	ra,4d80 <unlink>
  if(mkdir("dd") != 0){
    2b8c:	00004517          	auipc	a0,0x4
    2b90:	a0c50513          	addi	a0,a0,-1524 # 6598 <malloc+0x1382>
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    2ba4:	a1850513          	addi	a0,a0,-1512 # 65b8 <malloc+0x13a2>
  ...
  write(fd, "ff", 2);
    ...
    2bb8:	b1458593          	addi	a1,a1,-1260 # 66c8 <malloc+0x14b2>
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    2bee:	a4e50513          	addi	a0,a0,-1458 # 6638 <malloc+0x1422>
  ...
  write(fd, "FF", 2);
    ...
    2c02:	a6a58593          	addi	a1,a1,-1430 # 6668 <malloc+0x1452>
  ...
  fd = open("dd/dd/../ff", 0);
    ...
    2c16:	a5e50513          	addi	a0,a0,-1442 # 6670 <malloc+0x145a>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    2cfc:	94050513          	addi	a0,a0,-1728 # 6638 <malloc+0x1422>
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    2d10:	b4450513          	addi	a0,a0,-1212 # 6850 <malloc+0x163a>
  ...
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    ...
    2d24:	b6050513          	addi	a0,a0,-1184 # 6880 <malloc+0x166a>
  ...
  if(unlink("dd") < 0){
    ...
    2e82:	72250513          	addi	a0,a0,1826 # 65a0 <malloc+0x138a>
    2e86:	2d6020ef          	jal	ra,515c <printf>
    exit(1);
    2e8a:	4505                	li	a0,1
    ...
    2e96:	72e50513          	addi	a0,a0,1838 # 65c0 <malloc+0x13aa>
    2e9a:	2c2020ef          	jal	ra,515c <printf>
    exit(1);
    2e9e:	4505                	li	a0,1
    ...
    2eaa:	73a50513          	addi	a0,a0,1850 # 65e0 <malloc+0x13ca>
    2eae:	2ae020ef          	jal	ra,515c <printf>
    exit(1);
    2eb2:	4505                	li	a0,1
    ...
    2ebe:	75e50513          	addi	a0,a0,1886 # 6618 <malloc+0x1402>
    2ec2:	29a020ef          	jal	ra,515c <printf>
    exit(1);
    2ec6:	4505                	li	a0,1
    ...
    2ed2:	77a50513          	addi	a0,a0,1914 # 6648 <malloc+0x1432>
    2ed6:	286020ef          	jal	ra,515c <printf>
    exit(1);
    2eda:	4505                	li	a0,1
    ...
    2ee6:	79e50513          	addi	a0,a0,1950 # 6680 <malloc+0x146a>
    2eea:	272020ef          	jal	ra,515c <printf>
    exit(1);
    2eee:	4505                	li	a0,1
    ...
    2efa:	7aa50513          	addi	a0,a0,1962 # 66a0 <malloc+0x148a>
    2efe:	25e020ef          	jal	ra,515c <printf>
    exit(1);
    2f02:	4505                	li	a0,1
    ...
    2f0e:	7c650513          	addi	a0,a0,1990 # 66d0 <malloc+0x14ba>
    2f12:	24a020ef          	jal	ra,515c <printf>
    exit(1);
    2f16:	4505                	li	a0,1
    ...
    2f22:	7da50513          	addi	a0,a0,2010 # 66f8 <malloc+0x14e2>
    2f26:	236020ef          	jal	ra,515c <printf>
    exit(1);
    2f2a:	4505                	li	a0,1
    ...
    2f36:	7e650513          	addi	a0,a0,2022 # 6718 <malloc+0x1502>
    2f3a:	222020ef          	jal	ra,515c <printf>
    exit(1);
    2f3e:	4505                	li	a0,1
    ...
    2f4a:	7fa50513          	addi	a0,a0,2042 # 6740 <malloc+0x152a>
    2f4e:	20e020ef          	jal	ra,515c <printf>
    exit(1);
    2f52:	4505                	li	a0,1
    ...
    2f5e:	80e50513          	addi	a0,a0,-2034 # 6768 <malloc+0x1552>
    2f62:	1fa020ef          	jal	ra,515c <printf>
    exit(1);
    2f66:	4505                	li	a0,1
    ...
    2f72:	82a50513          	addi	a0,a0,-2006 # 6798 <malloc+0x1582>
    2f76:	1e6020ef          	jal	ra,515c <printf>
    exit(1);
    2f7a:	4505                	li	a0,1
    ...
    2f86:	84650513          	addi	a0,a0,-1978 # 67c8 <malloc+0x15b2>
    2f8a:	1d2020ef          	jal	ra,515c <printf>
    exit(1);
    2f8e:	4505                	li	a0,1
    ...
    2f9a:	84a50513          	addi	a0,a0,-1974 # 67e0 <malloc+0x15ca>
    2f9e:	1be020ef          	jal	ra,515c <printf>
    exit(1);
    2fa2:	4505                	li	a0,1
    ...
    2fae:	85650513          	addi	a0,a0,-1962 # 6800 <malloc+0x15ea>
    2fb2:	1aa020ef          	jal	ra,515c <printf>
    exit(1);
    2fb6:	4505                	li	a0,1
    ...
    2fc2:	86250513          	addi	a0,a0,-1950 # 6820 <malloc+0x160a>
    2fc6:	196020ef          	jal	ra,515c <printf>
    exit(1);
    2fca:	4505                	li	a0,1
    ...
    2fd6:	88e50513          	addi	a0,a0,-1906 # 6860 <malloc+0x164a>
    2fda:	182020ef          	jal	ra,515c <printf>
    exit(1);
    2fde:	4505                	li	a0,1
    ...
    2fea:	8aa50513          	addi	a0,a0,-1878 # 6890 <malloc+0x167a>
    2fee:	16e020ef          	jal	ra,515c <printf>
    exit(1);
    2ff2:	4505                	li	a0,1
    ...
    2ffe:	8b650513          	addi	a0,a0,-1866 # 68b0 <malloc+0x169a>
    3002:	15a020ef          	jal	ra,515c <printf>
    exit(1);
    3006:	4505                	li	a0,1
    ...
    3012:	8c250513          	addi	a0,a0,-1854 # 68d0 <malloc+0x16ba>
    3016:	146020ef          	jal	ra,515c <printf>
    exit(1);
    301a:	4505                	li	a0,1
    ...
    3026:	8ce50513          	addi	a0,a0,-1842 # 68f0 <malloc+0x16da>
    302a:	132020ef          	jal	ra,515c <printf>
    exit(1);
    302e:	4505                	li	a0,1
    ...
    303a:	8ea50513          	addi	a0,a0,-1814 # 6920 <malloc+0x170a>
    303e:	11e020ef          	jal	ra,515c <printf>
    exit(1);
    3042:	4505                	li	a0,1
    ...
    304e:	8fe50513          	addi	a0,a0,-1794 # 6948 <malloc+0x1732>
    3052:	10a020ef          	jal	ra,515c <printf>
    exit(1);
    3056:	4505                	li	a0,1
    ...
    3062:	91250513          	addi	a0,a0,-1774 # 6970 <malloc+0x175a>
    3066:	0f6020ef          	jal	ra,515c <printf>
    exit(1);
    306a:	4505                	li	a0,1
    ...
    3076:	92650513          	addi	a0,a0,-1754 # 6998 <malloc+0x1782>
    307a:	0e2020ef          	jal	ra,515c <printf>
    exit(1);
    307e:	4505                	li	a0,1
    ...
    308a:	93250513          	addi	a0,a0,-1742 # 69b8 <malloc+0x17a2>
    308e:	0ce020ef          	jal	ra,515c <printf>
    exit(1);
    3092:	4505                	li	a0,1
    ...
    309e:	93e50513          	addi	a0,a0,-1730 # 69d8 <malloc+0x17c2>
    30a2:	0ba020ef          	jal	ra,515c <printf>
    exit(1);
    30a6:	4505                	li	a0,1
    ...
    30b2:	95250513          	addi	a0,a0,-1710 # 6a00 <malloc+0x17ea>
    30b6:	0a6020ef          	jal	ra,515c <printf>
    exit(1);
    30ba:	4505                	li	a0,1
    ...
    30c6:	95e50513          	addi	a0,a0,-1698 # 6a20 <malloc+0x180a>
    30ca:	092020ef          	jal	ra,515c <printf>
    exit(1);
    30ce:	4505                	li	a0,1
    ...
    30da:	96a50513          	addi	a0,a0,-1686 # 6a40 <malloc+0x182a>
    30de:	07e020ef          	jal	ra,515c <printf>
    exit(1);
    30e2:	4505                	li	a0,1
    ...
    30ee:	97e50513          	addi	a0,a0,-1666 # 6a68 <malloc+0x1852>
    30f2:	06a020ef          	jal	ra,515c <printf>
    exit(1);
    30f6:	4505                	li	a0,1
    ...
    3102:	5fa50513          	addi	a0,a0,1530 # 66f8 <malloc+0x14e2>
    3106:	056020ef          	jal	ra,515c <printf>
    exit(1);
    310a:	4505                	li	a0,1
    ...
    3116:	97650513          	addi	a0,a0,-1674 # 6a88 <malloc+0x1872>
    311a:	042020ef          	jal	ra,515c <printf>
    exit(1);
    311e:	4505                	li	a0,1
    ...
    312a:	98250513          	addi	a0,a0,-1662 # 6aa8 <malloc+0x1892>
    312e:	02e020ef          	jal	ra,515c <printf>
    exit(1);
    3132:	4505                	li	a0,1
    ...
    313e:	99e50513          	addi	a0,a0,-1634 # 6ad8 <malloc+0x18c2>
    3142:	01a020ef          	jal	ra,515c <printf>
    exit(1);
    3146:	4505                	li	a0,1
    ...
    3152:	9aa50513          	addi	a0,a0,-1622 # 6af8 <malloc+0x18e2>
    3156:	006020ef          	jal	ra,515c <printf>
    exit(1);
    315a:	4505                	li	a0,1
...
0000000000003160 <rmdot>:
{
  ...
  if(unlink("dots") != 0){
    ...
    31ec:	93050513          	addi	a0,a0,-1744 # 6b18 <malloc+0x1902>
    31f0:	76d010ef          	jal	ra,515c <printf>
    exit(1);
    31f4:	4505                	li	a0,1
    ...
    3200:	93450513          	addi	a0,a0,-1740 # 6b30 <malloc+0x191a>
    3204:	759010ef          	jal	ra,515c <printf>
    exit(1);
    3208:	4505                	li	a0,1
    ...
    3214:	93850513          	addi	a0,a0,-1736 # 6b48 <malloc+0x1932>
    3218:	745010ef          	jal	ra,515c <printf>
    exit(1);
    321c:	4505                	li	a0,1
    ...
    3228:	93c50513          	addi	a0,a0,-1732 # 6b60 <malloc+0x194a>
    322c:	731010ef          	jal	ra,515c <printf>
    exit(1);
    3230:	4505                	li	a0,1
    ...
    323c:	2d850513          	addi	a0,a0,728 # 6510 <malloc+0x12fa>
    3240:	71d010ef          	jal	ra,515c <printf>
    exit(1);
    3244:	4505                	li	a0,1
    ...
    3250:	93450513          	addi	a0,a0,-1740 # 6b80 <malloc+0x196a>
    3254:	709010ef          	jal	ra,515c <printf>
    exit(1);
    3258:	4505                	li	a0,1
    ...
    3264:	94850513          	addi	a0,a0,-1720 # 6ba8 <malloc+0x1992>
    3268:	6f5010ef          	jal	ra,515c <printf>
    exit(1);
    326c:	4505                	li	a0,1
    ...
    3278:	95450513          	addi	a0,a0,-1708 # 6bc8 <malloc+0x19b2>
    327c:	6e1010ef          	jal	ra,515c <printf>
    exit(1);
    3280:	4505                	li	a0,1
...
0000000000003286 <dirfile>:
{
  ...
  fd = open("dirfile", O_CREATE);
    ...
    329c:	95050513          	addi	a0,a0,-1712 # 6be8 <malloc+0x19d2>
  ...
  if(chdir("dirfile") == 0){
    ...
    32b0:	93c50513          	addi	a0,a0,-1732 # 6be8 <malloc+0x19d2>
    32b4:	2ed010ef          	jal	ra,4da0 <chdir>
    32b8:	c569                	beqz	a0,3382 <dirfile+0xfc>
  fd = open("dirfile/xx", 0);
    32ba:	4581                	li	a1,0
    32bc:	00004517          	auipc	a0,0x4
    32c0:	97450513          	addi	a0,a0,-1676 # 6c30 <malloc+0x1a1a>
  ...
  fd = open(".", 0);
    ...
    3340:	70450513          	addi	a0,a0,1796 # 5a40 <malloc+0x82a>
    3344:	22d010ef          	jal	ra,4d70 <open>
    3348:	84aa                	mv	s1,a0
  if(write(fd, "x", 1) > 0){
    334a:	4605                	li	a2,1
    334c:	00002597          	auipc	a1,0x2
    3350:	07c58593          	addi	a1,a1,124 # 53c8 <malloc+0x1b2>
  ...
  close(fd);
    ...
    3374:	88050513          	addi	a0,a0,-1920 # 6bf0 <malloc+0x19da>
    3378:	5e5010ef          	jal	ra,515c <printf>
    exit(1);
    337c:	4505                	li	a0,1
    ...
    3388:	88c50513          	addi	a0,a0,-1908 # 6c10 <malloc+0x19fa>
    338c:	5d1010ef          	jal	ra,515c <printf>
    exit(1);
    3390:	4505                	li	a0,1
    ...
    339c:	8a850513          	addi	a0,a0,-1880 # 6c40 <malloc+0x1a2a>
    33a0:	5bd010ef          	jal	ra,515c <printf>
    exit(1);
    33a4:	4505                	li	a0,1
    ...
    33b0:	89450513          	addi	a0,a0,-1900 # 6c40 <malloc+0x1a2a>
    33b4:	5a9010ef          	jal	ra,515c <printf>
    exit(1);
    33b8:	4505                	li	a0,1
    ...
    33c4:	8a850513          	addi	a0,a0,-1880 # 6c68 <malloc+0x1a52>
    33c8:	595010ef          	jal	ra,515c <printf>
    exit(1);
    33cc:	4505                	li	a0,1
    ...
    33d8:	8bc50513          	addi	a0,a0,-1860 # 6c90 <malloc+0x1a7a>
    33dc:	581010ef          	jal	ra,515c <printf>
    exit(1);
    33e0:	4505                	li	a0,1
    ...
    33ec:	8d050513          	addi	a0,a0,-1840 # 6cb8 <malloc+0x1aa2>
    33f0:	56d010ef          	jal	ra,515c <printf>
    exit(1);
    33f4:	4505                	li	a0,1
    ...
    3400:	8e450513          	addi	a0,a0,-1820 # 6ce0 <malloc+0x1aca>
    3404:	559010ef          	jal	ra,515c <printf>
    exit(1);
    3408:	4505                	li	a0,1
    ...
    3414:	8f050513          	addi	a0,a0,-1808 # 6d00 <malloc+0x1aea>
    3418:	545010ef          	jal	ra,515c <printf>
    exit(1);
    341c:	4505                	li	a0,1
    ...
    3428:	90450513          	addi	a0,a0,-1788 # 6d28 <malloc+0x1b12>
    342c:	531010ef          	jal	ra,515c <printf>
    exit(1);
    3430:	4505                	li	a0,1
...
0000000000003436 <iref>:
{
    ...
    3454:	8f0a0a13          	addi	s4,s4,-1808 # 6d40 <malloc+0x1b2a>
    mkdir("");
    3458:	00003497          	auipc	s1,0x3
    345c:	3f048493          	addi	s1,s1,1008 # 6848 <malloc+0x1632>
    link("README", "");
    3460:	00002a97          	auipc	s5,0x2
    3464:	0d0a8a93          	addi	s5,s5,208 # 5530 <malloc+0x31a>
    fd = open("xx", O_CREATE);
    3468:	00003997          	auipc	s3,0x3
    346c:	7d098993          	addi	s3,s3,2000 # 6c38 <malloc+0x1a22>
    3470:	a835                	j	34ac <iref+0x76>
      printf("%s: mkdir irefd failed\n", s);
    3472:	85da                	mv	a1,s6
    3474:	00004517          	auipc	a0,0x4
    3478:	8d450513          	addi	a0,a0,-1836 # 6d48 <malloc+0x1b32>
    347c:	4e1010ef          	jal	ra,515c <printf>
      exit(1);
    3480:	4505                	li	a0,1
    ...
    348c:	8d850513          	addi	a0,a0,-1832 # 6d60 <malloc+0x1b4a>
    3490:	4cd010ef          	jal	ra,515c <printf>
      exit(1);
    3494:	4505                	li	a0,1
  ...
  for(i = 0; i < NINODE + 1; i++){
    ...
    34f4:	07098993          	addi	s3,s3,112 # 6560 <malloc+0x134a>
    unlink("irefd");
    34f8:	00004917          	auipc	s2,0x4
    34fc:	84890913          	addi	s2,s2,-1976 # 6d40 <malloc+0x1b2a>
    chdir("..");
    3500:	854e                	mv	a0,s3
  ...
  chdir("/");
    ...
    3514:	ff850513          	addi	a0,a0,-8 # 6508 <malloc+0x12f2>
...
0000000000003530 <openiputtest>:
{
  ...
  if(mkdir("oidir") < 0){
    ...
    3540:	83c50513          	addi	a0,a0,-1988 # 6d78 <malloc+0x1b62>
  ...
  if(pid == 0){
    ...
    355c:	82050513          	addi	a0,a0,-2016 # 6d78 <malloc+0x1b62>
    ...
    356e:	82e50513          	addi	a0,a0,-2002 # 6d98 <malloc+0x1b82>
    3572:	3eb010ef          	jal	ra,515c <printf>
      exit(1);
    3576:	4505                	li	a0,1
    ...
    3582:	80250513          	addi	a0,a0,-2046 # 6d80 <malloc+0x1b6a>
    3586:	3d7010ef          	jal	ra,515c <printf>
    exit(1);
    358a:	4505                	li	a0,1
    ...
    3596:	65650513          	addi	a0,a0,1622 # 5be8 <malloc+0x9d2>
    359a:	3c3010ef          	jal	ra,515c <printf>
    exit(1);
    359e:	4505                	li	a0,1
  ...
  if(unlink("oidir") != 0){
    ...
    35b4:	7c850513          	addi	a0,a0,1992 # 6d78 <malloc+0x1b62>
    35b8:	7c8010ef          	jal	ra,4d80 <unlink>
    35bc:	c919                	beqz	a0,35d2 <openiputtest+0xa2>
    printf("%s: unlink failed\n", s);
    35be:	85a6                	mv	a1,s1
    35c0:	00003517          	auipc	a0,0x3
    35c4:	81850513          	addi	a0,a0,-2024 # 5dd8 <malloc+0xbc2>
    35c8:	395010ef          	jal	ra,515c <printf>
    exit(1);
    35cc:	4505                	li	a0,1
...
00000000000035e2 <forkforkfork>:
{
  ...
  unlink("stopforking");
    ...
    35f2:	7d250513          	addi	a0,a0,2002 # 6dc0 <malloc+0x1baa>
  ...
  close(open("stopforking", O_CREATE|O_RDWR));
    ...
    3612:	7b250513          	addi	a0,a0,1970 # 6dc0 <malloc+0x1baa>
  ...
  pause(10); // one second
    ...
    363a:	77250513          	addi	a0,a0,1906 # 5da8 <malloc+0xb92>
    363e:	31f010ef          	jal	ra,515c <printf>
    exit(1);
    3642:	4505                	li	a0,1
    3644:	6ec010ef          	jal	ra,4d30 <exit>
      int fd = open("stopforking", 0);
    3648:	00003497          	auipc	s1,0x3
    364c:	77848493          	addi	s1,s1,1912 # 6dc0 <malloc+0x1baa>
    3650:	4581                	li	a1,0
    3652:	8526                	mv	a0,s1
...
000000000000367a <killstatus>:
{
  ...
  exit(0);
    ...
    36cc:	52050513          	addi	a0,a0,1312 # 5be8 <malloc+0x9d2>
    36d0:	28d010ef          	jal	ra,515c <printf>
      exit(1);
    36d4:	4505                	li	a0,1
    ...
    36e6:	6ee50513          	addi	a0,a0,1774 # 6dd0 <malloc+0x1bba>
    36ea:	273010ef          	jal	ra,515c <printf>
       exit(1);
    36ee:	4505                	li	a0,1
...
00000000000036f4 <preempt>:
{
  ...
  if(pid1 == 0)
    ...
    371a:	69250513          	addi	a0,a0,1682 # 5da8 <malloc+0xb92>
    371e:	23f010ef          	jal	ra,515c <printf>
    exit(1);
    3722:	4505                	li	a0,1
  ...
  if(pid2 == 0)
    ...
    373c:	4b050513          	addi	a0,a0,1200 # 5be8 <malloc+0x9d2>
    3740:	21d010ef          	jal	ra,515c <printf>
    exit(1);
    3744:	4505                	li	a0,1
  ...
  if(pid3 == 0){
    ...
    376c:	c6058593          	addi	a1,a1,-928 # 53c8 <malloc+0x1b2>
    ...
    378e:	45e50513          	addi	a0,a0,1118 # 5be8 <malloc+0x9d2>
    3792:	1cb010ef          	jal	ra,515c <printf>
     exit(1);
    3796:	4505                	li	a0,1
    ...
    37a2:	65250513          	addi	a0,a0,1618 # 6df0 <malloc+0x1bda>
    37a6:	1b7010ef          	jal	ra,515c <printf>
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
    ...
    37d2:	63a50513          	addi	a0,a0,1594 # 6e08 <malloc+0x1bf2>
    37d6:	187010ef          	jal	ra,515c <printf>
}
  ...
  printf("kill... ");
    ...
    37f6:	62e50513          	addi	a0,a0,1582 # 6e20 <malloc+0x1c0a>
    37fa:	163010ef          	jal	ra,515c <printf>
  kill(pid1);
    37fe:	8526                	mv	a0,s1
  ...
  printf("wait... ");
    ...
    3814:	62050513          	addi	a0,a0,1568 # 6e30 <malloc+0x1c1a>
    3818:	145010ef          	jal	ra,515c <printf>
  wait(0);
    381c:	4501                	li	a0,0
...
0000000000003830 <reparent>:
{
  ...
  exit(0);
    ...
    3874:	37850513          	addi	a0,a0,888 # 5be8 <malloc+0x9d2>
    3878:	0e5010ef          	jal	ra,515c <printf>
      exit(1);
    387c:	4505                	li	a0,1
    ...
    3888:	4ec50513          	addi	a0,a0,1260 # 5d70 <malloc+0xb5a>
    388c:	0d1010ef          	jal	ra,515c <printf>
        exit(1);
    3890:	4505                	li	a0,1
...
00000000000038b0 <sbrkfail>:
{
  ...
  if(pipe(fds) != 0){
    ...
    38ec:	40850513          	addi	a0,a0,1032 # 5cf0 <malloc+0xada>
    38f0:	06d010ef          	jal	ra,515c <printf>
    exit(1);
    38f4:	4505                	li	a0,1
    ...
    3916:	c8658593          	addi	a1,a1,-890 # 7598 <malloc+0x2382>
    ...
    3932:	51258593          	addi	a1,a1,1298 # 6e40 <malloc+0x1c2a>
  ...
  c = sbrk(PGSIZE);
    ...
    3984:	4c850513          	addi	a0,a0,1224 # 6e48 <malloc+0x1c32>
    3988:	7d4010ef          	jal	ra,515c <printf>
  ...
  if(pid == 0){
    ...
    39ce:	4ce50513          	addi	a0,a0,1230 # 6e98 <malloc+0x1c82>
    39d2:	78a010ef          	jal	ra,515c <printf>
    exit(1);
    39d6:	4505                	li	a0,1
    ...
    39e2:	49a50513          	addi	a0,a0,1178 # 6e78 <malloc+0x1c62>
    39e6:	776010ef          	jal	ra,515c <printf>
    exit(1);
    39ea:	4505                	li	a0,1
    ...
    39f6:	1f650513          	addi	a0,a0,502 # 5be8 <malloc+0x9d2>
    39fa:	762010ef          	jal	ra,515c <printf>
    exit(1);
    39fe:	4505                	li	a0,1
...
0000000000003a34 <mem>:
{
  ...
  if((pid = fork()) == 0){
    ...
    while((m2 = malloc(10001)) != 0){
    3a6c:	854a                	mv	a0,s2
    3a6e:	7a8010ef          	jal	ra,5216 <malloc>
    ...
    3a78:	6084                	ld	s1,0(s1)
      free(m1);
    3a7a:	714010ef          	jal	ra,518e <free>
    while(m1){
    3a7e:	fce5                	bnez	s1,3a76 <mem+0x42>
    m1 = malloc(1024*20);
    3a80:	6515                	lui	a0,0x5
    3a82:	794010ef          	jal	ra,5216 <malloc>
    if(m1 == 0){
    3a86:	c511                	beqz	a0,3a92 <mem+0x5e>
    free(m1);
    3a88:	706010ef          	jal	ra,518e <free>
    exit(0);
    3a8c:	4501                	li	a0,0
    ...
    3a98:	43450513          	addi	a0,a0,1076 # 6ec8 <malloc+0x1cb2>
    3a9c:	6c0010ef          	jal	ra,515c <printf>
      exit(1);
    3aa0:	4505                	li	a0,1
...
0000000000003aac <sharedfd>:
{
  ...
  unlink("sharedfd");
    ...
    3ac8:	42450513          	addi	a0,a0,1060 # 6ee8 <malloc+0x1cd2>
    3acc:	2b4010ef          	jal	ra,4d80 <unlink>
  fd = open("sharedfd", O_CREATE|O_RDWR);
    3ad0:	20200593          	li	a1,514
    3ad4:	00003517          	auipc	a0,0x3
    3ad8:	41450513          	addi	a0,a0,1044 # 6ee8 <malloc+0x1cd2>
  ...
  if(pid == 0) {
    ...
    3b2a:	3d250513          	addi	a0,a0,978 # 6ef8 <malloc+0x1ce2>
    3b2e:	62e010ef          	jal	ra,515c <printf>
    exit(1);
    3b32:	4505                	li	a0,1
    ...
    3b3e:	3e650513          	addi	a0,a0,998 # 6f20 <malloc+0x1d0a>
    3b42:	61a010ef          	jal	ra,515c <printf>
      exit(1);
    3b46:	4505                	li	a0,1
  ...
  fd = open("sharedfd", 0);
    ...
    3b6e:	37e50513          	addi	a0,a0,894 # 6ee8 <malloc+0x1cd2>
  ...
  while((n = read(fd, buf, sizeof(buf))) > 0){
    ...
    3ba6:	39e50513          	addi	a0,a0,926 # 6f40 <malloc+0x1d2a>
    3baa:	5b2010ef          	jal	ra,515c <printf>
    exit(1);
    3bae:	4505                	li	a0,1
  ...
  unlink("sharedfd");
    ...
    3bd6:	31650513          	addi	a0,a0,790 # 6ee8 <malloc+0x1cd2>
  ...
  if(nc == N*SZ && np == N*SZ){
    ...
    3bf8:	37450513          	addi	a0,a0,884 # 6f68 <malloc+0x1d52>
    3bfc:	560010ef          	jal	ra,515c <printf>
    exit(1);
    3c00:	4505                	li	a0,1
...
0000000000003c0c <fourfiles>:
{
  ...
  char *names[] = { "f0", "f1", "f2", "f3" };
    ...
    3c32:	6d278793          	addi	a5,a5,1746 # 5300 <malloc+0xea>
    3c36:	f6f43823          	sd	a5,-144(s0)
    3c3a:	00001797          	auipc	a5,0x1
    3c3e:	6ce78793          	addi	a5,a5,1742 # 5308 <malloc+0xf2>
    3c42:	f6f43c23          	sd	a5,-136(s0)
    3c46:	00001797          	auipc	a5,0x1
    3c4a:	6ca78793          	addi	a5,a5,1738 # 5310 <malloc+0xfa>
    3c4e:	f8f43023          	sd	a5,-128(s0)
    3c52:	00001797          	auipc	a5,0x1
    3c56:	6c678793          	addi	a5,a5,1734 # 5318 <malloc+0x102>
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    3cc2:	f2a50513          	addi	a0,a0,-214 # 5be8 <malloc+0x9d2>
    3cc6:	496010ef          	jal	ra,515c <printf>
      exit(1);
    3cca:	4505                	li	a0,1
    ...
    3d26:	f5e50513          	addi	a0,a0,-162 # 5c80 <malloc+0xa6a>
    3d2a:	432010ef          	jal	ra,515c <printf>
        exit(1);
    3d2e:	4505                	li	a0,1
    3d30:	000010ef          	jal	ra,4d30 <exit>
          printf("write failed %d\n", n);
    3d34:	00003517          	auipc	a0,0x3
    3d38:	24c50513          	addi	a0,a0,588 # 6f80 <malloc+0x1d6a>
    3d3c:	420010ef          	jal	ra,515c <printf>
          exit(1);
    3d40:	4505                	li	a0,1
    ...
    3d54:	24850513          	addi	a0,a0,584 # 6f98 <malloc+0x1d82>
    3d58:	404010ef          	jal	ra,515c <printf>
          exit(1);
    3d5c:	4505                	li	a0,1
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    3dca:	1e250513          	addi	a0,a0,482 # 6fa8 <malloc+0x1d92>
    3dce:	38e010ef          	jal	ra,515c <printf>
      exit(1);
    3dd2:	4505                	li	a0,1
...
0000000000003df6 <concreate>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    3e24:	1a0b8b93          	addi	s7,s7,416 # 6fc0 <malloc+0x1daa>
  for(i = 0; i < N; i++){
    ...
    3e5e:	16e50513          	addi	a0,a0,366 # 6fc8 <malloc+0x1db2>
    3e62:	2fa010ef          	jal	ra,515c <printf>
        exit(1);
    3e66:	4505                	li	a0,1
    ...
    3e74:	15050513          	addi	a0,a0,336 # 6fc0 <malloc+0x1daa>
  ...
  fd = open(".", 0);
    ...
    3e9c:	ba850513          	addi	a0,a0,-1112 # 5a40 <malloc+0x82a>
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    3f0a:	0e250513          	addi	a0,a0,226 # 6fe8 <malloc+0x1dd2>
    3f0e:	24e010ef          	jal	ra,515c <printf>
        exit(1);
    3f12:	4505                	li	a0,1
    ...
    3f22:	0ea50513          	addi	a0,a0,234 # 7008 <malloc+0x1df2>
    3f26:	236010ef          	jal	ra,515c <printf>
        exit(1);
    3f2a:	4505                	li	a0,1
  ...
  for(i = 0; i < N; i++){
    ...
    3f4e:	0e650513          	addi	a0,a0,230 # 7030 <malloc+0x1e1a>
    3f52:	20a010ef          	jal	ra,515c <printf>
    exit(1);
    3f56:	4505                	li	a0,1
    ...
    3f62:	c8a50513          	addi	a0,a0,-886 # 5be8 <malloc+0x9d2>
    3f66:	1f6010ef          	jal	ra,515c <printf>
      exit(1);
    3f6a:	4505                	li	a0,1
...
0000000000004098 <bigfile>:
{
  ...
  unlink("bigfile.dat");
    ...
    40b0:	fbc50513          	addi	a0,a0,-68 # 7068 <malloc+0x1e52>
    40b4:	4cd000ef          	jal	ra,4d80 <unlink>
  fd = open("bigfile.dat", O_CREATE | O_RDWR);
    40b8:	20200593          	li	a1,514
    40bc:	00003517          	auipc	a0,0x3
    40c0:	fac50513          	addi	a0,a0,-84 # 7068 <malloc+0x1e52>
  ...
  fd = open("bigfile.dat", 0);
    ...
    410c:	f6050513          	addi	a0,a0,-160 # 7068 <malloc+0x1e52>
  ...
  for(i = 0; ; i++){
    ...
    4168:	f1450513          	addi	a0,a0,-236 # 7078 <malloc+0x1e62>
    416c:	7f1000ef          	jal	ra,515c <printf>
    exit(1);
    4170:	4505                	li	a0,1
    ...
    417c:	f2050513          	addi	a0,a0,-224 # 7098 <malloc+0x1e82>
    4180:	7dd000ef          	jal	ra,515c <printf>
      exit(1);
    4184:	4505                	li	a0,1
    ...
    4190:	f2c50513          	addi	a0,a0,-212 # 70b8 <malloc+0x1ea2>
    4194:	7c9000ef          	jal	ra,515c <printf>
    exit(1);
    4198:	4505                	li	a0,1
    ...
    41a4:	f3850513          	addi	a0,a0,-200 # 70d8 <malloc+0x1ec2>
    41a8:	7b5000ef          	jal	ra,515c <printf>
      exit(1);
    41ac:	4505                	li	a0,1
    ...
    41b8:	f4450513          	addi	a0,a0,-188 # 70f8 <malloc+0x1ee2>
    41bc:	7a1000ef          	jal	ra,515c <printf>
      exit(1);
    41c0:	4505                	li	a0,1
    ...
    41cc:	f4850513          	addi	a0,a0,-184 # 7110 <malloc+0x1efa>
    41d0:	78d000ef          	jal	ra,515c <printf>
      exit(1);
    41d4:	4505                	li	a0,1
  ...
  unlink("bigfile.dat");
    ...
    41ee:	e7e50513          	addi	a0,a0,-386 # 7068 <malloc+0x1e52>
    ...
    420e:	f2650513          	addi	a0,a0,-218 # 7130 <malloc+0x1f1a>
    4212:	74b000ef          	jal	ra,515c <printf>
    exit(1);
    4216:	4505                	li	a0,1
...
000000000000421c <bigargtest>:
{
  ...
  unlink("bigarg-ok");
    ...
    422c:	f2850513          	addi	a0,a0,-216 # 7150 <malloc+0x1f3a>
  ...
  fd = open("bigarg-ok", 0);
    ...
    4252:	f0250513          	addi	a0,a0,-254 # 7150 <malloc+0x1f3a>
  ...
  close(fd);
    ...
    42ac:	0b050513          	addi	a0,a0,176 # 5358 <malloc+0x142>
    42b0:	2b9000ef          	jal	ra,4d68 <exec>
    fd = open("bigarg-ok", O_CREATE);
    42b4:	20000593          	li	a1,512
    42b8:	00003517          	auipc	a0,0x3
    42bc:	e9850513          	addi	a0,a0,-360 # 7150 <malloc+0x1f3a>
    ...
    42d4:	e9050513          	addi	a0,a0,-368 # 7160 <malloc+0x1f4a>
    42d8:	685000ef          	jal	ra,515c <printf>
    exit(1);
    42dc:	4505                	li	a0,1
    ...
    42ec:	e9850513          	addi	a0,a0,-360 # 7180 <malloc+0x1f6a>
    42f0:	66d000ef          	jal	ra,515c <printf>
    exit(1);
    42f4:	4505                	li	a0,1
...
00000000000042fa <lazy_alloc>:
{
  ...
  exit(0);
    ...
    4342:	e6250513          	addi	a0,a0,-414 # 71a0 <malloc+0x1f8a>
    4346:	617000ef          	jal	ra,515c <printf>
    exit(1);
    434a:	4505                	li	a0,1
    434c:	1e5000ef          	jal	ra,4d30 <exit>
      printf("failed to read value from memory\n");
    4350:	00003517          	auipc	a0,0x3
    4354:	e6850513          	addi	a0,a0,-408 # 71b8 <malloc+0x1fa2>
    4358:	605000ef          	jal	ra,515c <printf>
      exit(1);
    435c:	4505                	li	a0,1
...
0000000000004362 <lazy_unmap>:
{
  ...
  exit(0);
    ...
    43c2:	de250513          	addi	a0,a0,-542 # 71a0 <malloc+0x1f8a>
    43c6:	597000ef          	jal	ra,515c <printf>
    exit(1);
    43ca:	4505                	li	a0,1
    43cc:	165000ef          	jal	ra,4d30 <exit>
      printf("error forking\n");
    43d0:	00003517          	auipc	a0,0x3
    43d4:	e1050513          	addi	a0,a0,-496 # 71e0 <malloc+0x1fca>
    43d8:	585000ef          	jal	ra,515c <printf>
      exit(1);
    43dc:	4505                	li	a0,1
    ...
    43f8:	dfc50513          	addi	a0,a0,-516 # 71f0 <malloc+0x1fda>
    43fc:	561000ef          	jal	ra,515c <printf>
        exit(1);
    4400:	4505                	li	a0,1
...
0000000000004406 <lazy_copy>:
{
    ...
    444e:	dbe50513          	addi	a0,a0,-578 # 7208 <malloc+0x1ff2>
    4452:	50b000ef          	jal	ra,515c <printf>
      exit(1);
    4456:	4505                	li	a0,1
    4458:	0d9000ef          	jal	ra,4d30 <exit>
  unsigned long bad[] = {
    445c:	00003797          	auipc	a5,0x3
    4460:	41c78793          	addi	a5,a5,1052 # 7878 <malloc+0x2662>
  ...
  for(int i = 0; i < sizeof(bad)/sizeof(bad[0]); i++){
    ...
    4494:	0a0a0a13          	addi	s4,s4,160 # 5530 <malloc+0x31a>
    fd = open("junk", O_CREATE|O_RDWR|O_TRUNC);
    4498:	00001a97          	auipc	s5,0x1
    449c:	fa8a8a93          	addi	s5,s5,-88 # 5440 <malloc+0x22a>
    int fd = open("README", 0);
    44a0:	4581                	li	a1,0
    44a2:	8552                	mv	a0,s4
  ...
  exit(0);
    ...
    44fa:	d4250513          	addi	a0,a0,-702 # 7238 <malloc+0x2022>
    44fe:	45f000ef          	jal	ra,515c <printf>
    4502:	4505                	li	a0,1
    4504:	02d000ef          	jal	ra,4d30 <exit>
    if(read(fd, (char*)bad[i], 512) >= 0) { printf("read succeeded\n");  exit(1); }
    4508:	00003517          	auipc	a0,0x3
    450c:	d4850513          	addi	a0,a0,-696 # 7250 <malloc+0x203a>
    4510:	44d000ef          	jal	ra,515c <printf>
    4514:	4505                	li	a0,1
    4516:	01b000ef          	jal	ra,4d30 <exit>
    if(fd < 0) { printf("cannot open junk\n"); exit(1); }
    451a:	00003517          	auipc	a0,0x3
    451e:	d4650513          	addi	a0,a0,-698 # 7260 <malloc+0x204a>
    4522:	43b000ef          	jal	ra,515c <printf>
    4526:	4505                	li	a0,1
    4528:	009000ef          	jal	ra,4d30 <exit>
    if(write(fd, (char*)bad[i], 512) >= 0) { printf("write succeeded\n"); exit(1); }
    452c:	00003517          	auipc	a0,0x3
    4530:	d4c50513          	addi	a0,a0,-692 # 7278 <malloc+0x2062>
    4534:	429000ef          	jal	ra,515c <printf>
    4538:	4505                	li	a0,1
...
000000000000453e <lazy_sbrk>:
{
  ...
  if (p1 < 0 || p1 != p) {
    ...
    458c:	d0850513          	addi	a0,a0,-760 # 7290 <malloc+0x207a>
    4590:	3cd000ef          	jal	ra,515c <printf>
    exit(1);
    4594:	4505                	li	a0,1
  ...
  if (p < 0 || (uint64)p != TRAPFRAME-PGSIZE) {
    ...
    45b4:	d1050513          	addi	a0,a0,-752 # 72c0 <malloc+0x20aa>
    45b8:	3a5000ef          	jal	ra,515c <printf>
    exit(1);
    45bc:	4505                	li	a0,1
  ...
  if (p[1] != 0) {
    ...
    45da:	d2250513          	addi	a0,a0,-734 # 72f8 <malloc+0x20e2>
    45de:	37f000ef          	jal	ra,515c <printf>
    exit(1);
    45e2:	4505                	li	a0,1
  ...
  if ((uint64)p != -1) {
    ...
    45fa:	d2a50513          	addi	a0,a0,-726 # 7320 <malloc+0x210a>
    45fe:	35f000ef          	jal	ra,515c <printf>
    exit(1);
    4602:	4505                	li	a0,1
  ...
  if ((uint64)p != -1) {
    ...
    461a:	d3250513          	addi	a0,a0,-718 # 7348 <malloc+0x2132>
    461e:	33f000ef          	jal	ra,515c <printf>
    exit(1);
    4622:	4505                	li	a0,1
...
000000000000462e <fsfull>:
{
  ...
  printf("fsfull test\n");
    ...
    4650:	d2c50513          	addi	a0,a0,-724 # 7378 <malloc+0x2162>
    4654:	309000ef          	jal	ra,515c <printf>
  for(nfiles = 0; ; nfiles++){
    4658:	4481                	li	s1,0
    name[0] = 'f';
    ...
    466c:	d20c8c93          	addi	s9,s9,-736 # 7388 <malloc+0x2172>
    int total = 0;
    4670:	4d81                	li	s11,0
    ...
    46be:	8566                	mv	a0,s9
    46c0:	29d000ef          	jal	ra,515c <printf>
    int fd = open(name, O_CREATE|O_RDWR);
    ...
    46de:	cbe50513          	addi	a0,a0,-834 # 7398 <malloc+0x2182>
    46e2:	27b000ef          	jal	ra,515c <printf>
  while(nfiles >= 0){
  ...
  printf("fsfull test finished\n");
    ...
    474c:	c7050513          	addi	a0,a0,-912 # 73b8 <malloc+0x21a2>
    4750:	20d000ef          	jal	ra,515c <printf>
}
    ...
    4794:	c1850513          	addi	a0,a0,-1000 # 73a8 <malloc+0x2192>
    4798:	1c5000ef          	jal	ra,515c <printf>
    close(fd);
    479c:	854a                	mv	a0,s2
...
run(void f(char *), char *s) {
  ...
  printf("test %s: ", s);
    ...
    47be:	c1650513          	addi	a0,a0,-1002 # 73d0 <malloc+0x21ba>
    47c2:	19b000ef          	jal	ra,515c <printf>
  if((pid = fork()) < 0) {
  ...
  if(pid == 0) {
    ...
    47e2:	c1a50513          	addi	a0,a0,-998 # 73f8 <malloc+0x21e2>
    47e6:	177000ef          	jal	ra,515c <printf>
    else
      printf("OK\n");
    return xstatus == 0;
    ...
    4802:	be250513          	addi	a0,a0,-1054 # 73e0 <malloc+0x21ca>
    4806:	157000ef          	jal	ra,515c <printf>
    exit(1);
    480a:	4505                	li	a0,1
    ...
    481e:	be650513          	addi	a0,a0,-1050 # 7400 <malloc+0x21ea>
    4822:	13b000ef          	jal	ra,515c <printf>
...
runtests(struct test *tests, char *justone, int continuous) {
  ...
  for (struct test *t = tests; t->s != 0; t++) {
    ...
    4870:	b9c50513          	addi	a0,a0,-1124 # 7408 <malloc+0x21f2>
    4874:	0e9000ef          	jal	ra,515c <printf>
          return -1;
    4878:	59fd                	li	s3,-1
        }
      }
...
drivetests(int quick, int continuous, char *justone) {
  ...
  do {
    ...
    4900:	b24b8b93          	addi	s7,s7,-1244 # 7420 <malloc+0x220a>
    int free0 = countfree();
    int free1 = 0;
    int ntests = 0;
    int n;
    ...
    4912:	b4ad0d13          	addi	s10,s10,-1206 # 7458 <malloc+0x2242>
    ...
    4922:	b1ad8d93          	addi	s11,s11,-1254 # 7438 <malloc+0x2222>
    ...
    492e:	a881                	j	497e <drivetests+0xa6>
        printf("usertests slow tests starting\n");
    4930:	856e                	mv	a0,s11
    4932:	02b000ef          	jal	ra,515c <printf>
    ...
    4946:	85aa                	mv	a1,a0
    4948:	856a                	mv	a0,s10
    494a:	013000ef          	jal	ra,515c <printf>
      if(continuous != 2) {
    ...
    printf("usertests starting\n");
    4962:	855e                	mv	a0,s7
    4964:	7f8000ef          	jal	ra,515c <printf>
    int free0 = countfree();
    ...
    499a:	85aa                	mv	a1,a0
    499c:	856a                	mv	a0,s10
    499e:	7be000ef          	jal	ra,515c <printf>
      if(continuous != 2) {
    ...
    49b0:	adc50513          	addi	a0,a0,-1316 # 7488 <malloc+0x2272>
    49b4:	7a8000ef          	jal	ra,515c <printf>
      return 1;
    49b8:	4505                	li	a0,1
...
main(int argc, char *argv[])
{
  ...
  if(argc == 2 && strcmp(argv[1], "-q") == 0){
    ...
    4a1c:	a8858593          	addi	a1,a1,-1400 # 74a0 <malloc+0x228a>
  ...
  int continuous = 0;
    ...
    4a68:	a4450513          	addi	a0,a0,-1468 # 74a8 <malloc+0x2292>
    4a6c:	6f0000ef          	jal	ra,515c <printf>
    exit(1);
    4a70:	4505                	li	a0,1
  ...
  printf("ALL TESTS PASSED\n");
    ...
    4a8c:	a5050513          	addi	a0,a0,-1456 # 74d8 <malloc+0x22c2>
    4a90:	6cc000ef          	jal	ra,515c <printf>
  exit(0);
    4a94:	4501                	li	a0,0
...
putc(int fd, char c)
{
    4de0:	1101                	addi	sp,sp,-32
    4de2:	ec06                	sd	ra,24(sp)
    4de4:	e822                	sd	s0,16(sp)
    4de6:	1000                	addi	s0,sp,32
    4de8:	feb407a3          	sb	a1,-17(s0)
  write(fd, &c, 1);
    4dec:	4605                	li	a2,1
    4dee:	fef40593          	addi	a1,s0,-17
    4df2:	f5fff0ef          	jal	ra,4d50 <write>
}
    4df6:	60e2                	ld	ra,24(sp)
    4df8:	6442                	ld	s0,16(sp)
    4dfa:	6105                	addi	sp,sp,32
    4dfc:	8082                	ret

0000000000004dfe <printint>:

static void
printint(int fd, long long xx, int base, int sgn)
{
    4dfe:	715d                	addi	sp,sp,-80
    4e00:	e486                	sd	ra,72(sp)
    4e02:	e0a2                	sd	s0,64(sp)
    4e04:	fc26                	sd	s1,56(sp)
    4e06:	f84a                	sd	s2,48(sp)
    4e08:	f44e                	sd	s3,40(sp)
    4e0a:	0880                	addi	s0,sp,80
    4e0c:	892a                	mv	s2,a0
  char buf[20];
  int i, neg;
  ...
  neg = 0;
  if(sgn && xx < 0){
    4e0e:	c299                	beqz	a3,4e14 <printint+0x16>
    4e10:	0805c163          	bltz	a1,4e92 <printint+0x94>
  neg = 0;
    4e14:	4881                	li	a7,0
    4e16:	fb840693          	addi	a3,s0,-72
    x = -xx;
  } else {
    x = xx;
  }
  ...
  do{
    ...
    4e20:	b0c50513          	addi	a0,a0,-1268 # 7928 <digits>
    4e24:	883e                	mv	a6,a5
    4e26:	2785                	addiw	a5,a5,1
    4e28:	02c5f733          	remu	a4,a1,a2
    4e2c:	972a                	add	a4,a4,a0
    4e2e:	00074703          	lbu	a4,0(a4)
    4e32:	00e68023          	sb	a4,0(a3)
  }while((x /= base) != 0);
    4e36:	872e                	mv	a4,a1
    4e38:	02c5d5b3          	divu	a1,a1,a2
    4e3c:	0685                	addi	a3,a3,1
    4e3e:	fec773e3          	bgeu	a4,a2,4e24 <printint+0x26>
  if(neg)
    4e42:	00088b63          	beqz	a7,4e58 <printint+0x5a>
    buf[i++] = '-';
    4e46:	fd040713          	addi	a4,s0,-48
    4e4a:	97ba                	add	a5,a5,a4
    4e4c:	02d00713          	li	a4,45
    4e50:	fee78423          	sb	a4,-24(a5)
    4e54:	0028079b          	addiw	a5,a6,2

  while(--i >= 0)
    4e58:	02f05663          	blez	a5,4e84 <printint+0x86>
    4e5c:	fb840713          	addi	a4,s0,-72
    4e60:	00f704b3          	add	s1,a4,a5
    4e64:	fff70993          	addi	s3,a4,-1
    4e68:	99be                	add	s3,s3,a5
    4e6a:	37fd                	addiw	a5,a5,-1
    4e6c:	1782                	slli	a5,a5,0x20
    4e6e:	9381                	srli	a5,a5,0x20
    4e70:	40f989b3          	sub	s3,s3,a5
    putc(fd, buf[i]);
    4e74:	fff4c583          	lbu	a1,-1(s1) # 40000fff <base+0x3fff2347>
    4e78:	854a                	mv	a0,s2
    4e7a:	f67ff0ef          	jal	ra,4de0 <putc>
  while(--i >= 0)
    4e7e:	14fd                	addi	s1,s1,-1
    4e80:	ff349ae3          	bne	s1,s3,4e74 <printint+0x76>
}
    4e84:	60a6                	ld	ra,72(sp)
    4e86:	6406                	ld	s0,64(sp)
    4e88:	74e2                	ld	s1,56(sp)
    4e8a:	7942                	ld	s2,48(sp)
    4e8c:	79a2                	ld	s3,40(sp)
    4e8e:	6161                	addi	sp,sp,80
    4e90:	8082                	ret
    x = -xx;
    4e92:	40b005b3          	neg	a1,a1
    neg = 1;
    4e96:	4885                	li	a7,1
    x = -xx;
    4e98:	bfbd                	j	4e16 <printint+0x18>

0000000000004e9a <vprintf>:
}
...
{
    4e9a:	7119                	addi	sp,sp,-128
    4e9c:	fc86                	sd	ra,120(sp)
    4e9e:	f8a2                	sd	s0,112(sp)
    4ea0:	f4a6                	sd	s1,104(sp)
    4ea2:	f0ca                	sd	s2,96(sp)
    4ea4:	ecce                	sd	s3,88(sp)
    4ea6:	e8d2                	sd	s4,80(sp)
    4ea8:	e4d6                	sd	s5,72(sp)
    4eaa:	e0da                	sd	s6,64(sp)
    4eac:	fc5e                	sd	s7,56(sp)
    4eae:	f862                	sd	s8,48(sp)
    4eb0:	f466                	sd	s9,40(sp)
    4eb2:	f06a                	sd	s10,32(sp)
    4eb4:	ec6e                	sd	s11,24(sp)
    4eb6:	0100                	addi	s0,sp,128
  char *s;
  int c0, c1, c2, i, state;

  state = 0;
  for(i = 0; fmt[i]; i++){
    4eb8:	0005c903          	lbu	s2,0(a1)
    4ebc:	24090c63          	beqz	s2,5114 <vprintf+0x27a>
    4ec0:	8b2a                	mv	s6,a0
    4ec2:	8a2e                	mv	s4,a1
    4ec4:	8bb2                	mv	s7,a2
  state = 0;
  ...
  for(i = 0; fmt[i]; i++){
    ...
    4ecc:	02500a93          	li	s5,37
      c1 = c2 = 0;
      if(c0) c1 = fmt[i+1] & 0xff;
      if(c1) c2 = fmt[i+2] & 0xff;
      if(c0 == 'd'){
    4ed0:	06400c13          	li	s8,100
        printint(fd, va_arg(ap, int), 10, 1);
      } else if(c0 == 'l' && c1 == 'd'){
    4ed4:	06c00d13          	li	s10,108
    ...
    4ed8:	07500d93          	li	s11,117
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
    4edc:	00003c97          	auipc	s9,0x3
    4ee0:	a4cc8c93          	addi	s9,s9,-1460 # 7928 <digits>
    4ee4:	a005                	j	4f04 <vprintf+0x6a>
        putc(fd, c0);
    4ee6:	85ca                	mv	a1,s2
    4ee8:	855a                	mv	a0,s6
    4eea:	ef7ff0ef          	jal	ra,4de0 <putc>
    4eee:	a019                	j	4ef4 <vprintf+0x5a>
    } else if(state == '%'){
    4ef0:	03598263          	beq	s3,s5,4f14 <vprintf+0x7a>
  for(i = 0; fmt[i]; i++){
    4ef4:	2485                	addiw	s1,s1,1
    4ef6:	8726                	mv	a4,s1
    4ef8:	009a07b3          	add	a5,s4,s1
    4efc:	0007c903          	lbu	s2,0(a5)
    4f00:	20090a63          	beqz	s2,5114 <vprintf+0x27a>
    c0 = fmt[i] & 0xff;
    4f04:	0009079b          	sext.w	a5,s2
    if(state == 0){
    4f08:	fe0994e3          	bnez	s3,4ef0 <vprintf+0x56>
      if(c0 == '%'){
    4f0c:	fd579de3          	bne	a5,s5,4ee6 <vprintf+0x4c>
        state = '%';
    4f10:	89be                	mv	s3,a5
    4f12:	b7cd                	j	4ef4 <vprintf+0x5a>
      if(c0) c1 = fmt[i+1] & 0xff;
    4f14:	c3c1                	beqz	a5,4f94 <vprintf+0xfa>
    4f16:	00ea06b3          	add	a3,s4,a4
    4f1a:	0016c683          	lbu	a3,1(a3)
      c1 = c2 = 0;
    4f1e:	8636                	mv	a2,a3
      if(c1) c2 = fmt[i+2] & 0xff;
    4f20:	c681                	beqz	a3,4f28 <vprintf+0x8e>
    4f22:	9752                	add	a4,a4,s4
    4f24:	00274603          	lbu	a2,2(a4)
      if(c0 == 'd'){
    4f28:	03878e63          	beq	a5,s8,4f64 <vprintf+0xca>
      } else if(c0 == 'l' && c1 == 'd'){
    4f2c:	05a78863          	beq	a5,s10,4f7c <vprintf+0xe2>
      } else if(c0 == 'u'){
    4f30:	0db78b63          	beq	a5,s11,5006 <vprintf+0x16c>
    ...
    4f34:	07800713          	li	a4,120
    4f38:	10e78d63          	beq	a5,a4,5052 <vprintf+0x1b8>
    ...
    4f3c:	07000713          	li	a4,112
    4f40:	14e78263          	beq	a5,a4,5084 <vprintf+0x1ea>
        printptr(fd, va_arg(ap, uint64));
      } else if(c0 == 'c'){
    4f44:	06300713          	li	a4,99
    4f48:	16e78f63          	beq	a5,a4,50c6 <vprintf+0x22c>
        putc(fd, va_arg(ap, uint32));
      } else if(c0 == 's'){
    4f4c:	07300713          	li	a4,115
    4f50:	18e78563          	beq	a5,a4,50da <vprintf+0x240>
        if((s = va_arg(ap, char*)) == 0)
          s = "(null)";
        for(; *s; s++)
          putc(fd, *s);
      } else if(c0 == '%'){
    4f54:	05579063          	bne	a5,s5,4f94 <vprintf+0xfa>
        putc(fd, '%');
    4f58:	85d6                	mv	a1,s5
    4f5a:	855a                	mv	a0,s6
    4f5c:	e85ff0ef          	jal	ra,4de0 <putc>
      ...
      state = 0;
    4f60:	4981                	li	s3,0
    4f62:	bf49                	j	4ef4 <vprintf+0x5a>
        printint(fd, va_arg(ap, int), 10, 1);
    4f64:	008b8913          	addi	s2,s7,8
    4f68:	4685                	li	a3,1
    4f6a:	4629                	li	a2,10
    4f6c:	000ba583          	lw	a1,0(s7)
    4f70:	855a                	mv	a0,s6
    4f72:	e8dff0ef          	jal	ra,4dfe <printint>
    4f76:	8bca                	mv	s7,s2
      state = 0;
    4f78:	4981                	li	s3,0
    4f7a:	bfad                	j	4ef4 <vprintf+0x5a>
      } else if(c0 == 'l' && c1 == 'd'){
    4f7c:	03868663          	beq	a3,s8,4fa8 <vprintf+0x10e>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'd'){
    4f80:	05a68163          	beq	a3,s10,4fc2 <vprintf+0x128>
      } else if(c0 == 'l' && c1 == 'u'){
    4f84:	09b68d63          	beq	a3,s11,501e <vprintf+0x184>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'u'){
    4f88:	03a68f63          	beq	a3,s10,4fc6 <vprintf+0x12c>
      } else if(c0 == 'l' && c1 == 'x'){
    4f8c:	07800793          	li	a5,120
    4f90:	0cf68d63          	beq	a3,a5,506a <vprintf+0x1d0>
        putc(fd, '%');
    4f94:	85d6                	mv	a1,s5
    4f96:	855a                	mv	a0,s6
    4f98:	e49ff0ef          	jal	ra,4de0 <putc>
        putc(fd, c0);
    4f9c:	85ca                	mv	a1,s2
    4f9e:	855a                	mv	a0,s6
    4fa0:	e41ff0ef          	jal	ra,4de0 <putc>
      state = 0;
    4fa4:	4981                	li	s3,0
    4fa6:	b7b9                	j	4ef4 <vprintf+0x5a>
        printint(fd, va_arg(ap, uint64), 10, 1);
    4fa8:	008b8913          	addi	s2,s7,8
    4fac:	4685                	li	a3,1
    4fae:	4629                	li	a2,10
    4fb0:	000bb583          	ld	a1,0(s7)
    4fb4:	855a                	mv	a0,s6
    4fb6:	e49ff0ef          	jal	ra,4dfe <printint>
        i += 1;
    ...
    4fbe:	4981                	li	s3,0
        i += 1;
    4fc0:	bf15                	j	4ef4 <vprintf+0x5a>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'd'){
    4fc2:	03860563          	beq	a2,s8,4fec <vprintf+0x152>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'u'){
    4fc6:	07b60963          	beq	a2,s11,5038 <vprintf+0x19e>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'x'){
    4fca:	07800793          	li	a5,120
    4fce:	fcf613e3          	bne	a2,a5,4f94 <vprintf+0xfa>
        printint(fd, va_arg(ap, uint64), 16, 0);
    4fd2:	008b8913          	addi	s2,s7,8
    4fd6:	4681                	li	a3,0
    4fd8:	4641                	li	a2,16
    4fda:	000bb583          	ld	a1,0(s7)
    4fde:	855a                	mv	a0,s6
    4fe0:	e1fff0ef          	jal	ra,4dfe <printint>
        i += 2;
    4fe4:	2489                	addiw	s1,s1,2
        printint(fd, va_arg(ap, uint64), 16, 0);
    4fe6:	8bca                	mv	s7,s2
      state = 0;
    4fe8:	4981                	li	s3,0
        i += 2;
    4fea:	b729                	j	4ef4 <vprintf+0x5a>
        printint(fd, va_arg(ap, uint64), 10, 1);
    4fec:	008b8913          	addi	s2,s7,8
    4ff0:	4685                	li	a3,1
    4ff2:	4629                	li	a2,10
    4ff4:	000bb583          	ld	a1,0(s7)
    4ff8:	855a                	mv	a0,s6
    4ffa:	e05ff0ef          	jal	ra,4dfe <printint>
        i += 2;
    4ffe:	2489                	addiw	s1,s1,2
        printint(fd, va_arg(ap, uint64), 10, 1);
    5000:	8bca                	mv	s7,s2
      state = 0;
    5002:	4981                	li	s3,0
        i += 2;
    5004:	bdc5                	j	4ef4 <vprintf+0x5a>
        printint(fd, va_arg(ap, uint32), 10, 0);
    5006:	008b8913          	addi	s2,s7,8
    500a:	4681                	li	a3,0
    500c:	4629                	li	a2,10
    500e:	000be583          	lwu	a1,0(s7)
    5012:	855a                	mv	a0,s6
    5014:	debff0ef          	jal	ra,4dfe <printint>
    5018:	8bca                	mv	s7,s2
      state = 0;
    501a:	4981                	li	s3,0
    501c:	bde1                	j	4ef4 <vprintf+0x5a>
        printint(fd, va_arg(ap, uint64), 10, 0);
    501e:	008b8913          	addi	s2,s7,8
    5022:	4681                	li	a3,0
    5024:	4629                	li	a2,10
    5026:	000bb583          	ld	a1,0(s7)
    502a:	855a                	mv	a0,s6
    502c:	dd3ff0ef          	jal	ra,4dfe <printint>
        i += 1;
    5030:	2485                	addiw	s1,s1,1
        printint(fd, va_arg(ap, uint64), 10, 0);
    5032:	8bca                	mv	s7,s2
      state = 0;
    5034:	4981                	li	s3,0
        i += 1;
    5036:	bd7d                	j	4ef4 <vprintf+0x5a>
        printint(fd, va_arg(ap, uint64), 10, 0);
    ...
    5044:	855a                	mv	a0,s6
    5046:	db9ff0ef          	jal	ra,4dfe <printint>
        i += 2;
    ...
    504e:	4981                	li	s3,0
        i += 2;
    5050:	b555                	j	4ef4 <vprintf+0x5a>
        printint(fd, va_arg(ap, uint32), 16, 0);
    5052:	008b8913          	addi	s2,s7,8
    5056:	4681                	li	a3,0
    5058:	4641                	li	a2,16
    505a:	000be583          	lwu	a1,0(s7)
    505e:	855a                	mv	a0,s6
    5060:	d9fff0ef          	jal	ra,4dfe <printint>
    5064:	8bca                	mv	s7,s2
      state = 0;
    5066:	4981                	li	s3,0
    5068:	b571                	j	4ef4 <vprintf+0x5a>
        printint(fd, va_arg(ap, uint64), 16, 0);
    506a:	008b8913          	addi	s2,s7,8
    506e:	4681                	li	a3,0
    5070:	4641                	li	a2,16
    5072:	000bb583          	ld	a1,0(s7)
    5076:	855a                	mv	a0,s6
    5078:	d87ff0ef          	jal	ra,4dfe <printint>
        i += 1;
    ...
    5080:	4981                	li	s3,0
        i += 1;
    5082:	bd8d                	j	4ef4 <vprintf+0x5a>
        printptr(fd, va_arg(ap, uint64));
    5084:	008b8793          	addi	a5,s7,8
    5088:	f8f43423          	sd	a5,-120(s0)
    508c:	000bb983          	ld	s3,0(s7)
  putc(fd, '0');
    5090:	03000593          	li	a1,48
    5094:	855a                	mv	a0,s6
    5096:	d4bff0ef          	jal	ra,4de0 <putc>
  putc(fd, 'x');
    509a:	07800593          	li	a1,120
    509e:	855a                	mv	a0,s6
    50a0:	d41ff0ef          	jal	ra,4de0 <putc>
    50a4:	4941                	li	s2,16
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
    50a6:	03c9d793          	srli	a5,s3,0x3c
    50aa:	97e6                	add	a5,a5,s9
    50ac:	0007c583          	lbu	a1,0(a5)
    50b0:	855a                	mv	a0,s6
    50b2:	d2fff0ef          	jal	ra,4de0 <putc>
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    50b6:	0992                	slli	s3,s3,0x4
    50b8:	397d                	addiw	s2,s2,-1
    50ba:	fe0916e3          	bnez	s2,50a6 <vprintf+0x20c>
        printptr(fd, va_arg(ap, uint64));
    50be:	f8843b83          	ld	s7,-120(s0)
      state = 0;
    50c2:	4981                	li	s3,0
    50c4:	bd05                	j	4ef4 <vprintf+0x5a>
        putc(fd, va_arg(ap, uint32));
    50c6:	008b8913          	addi	s2,s7,8
    50ca:	000bc583          	lbu	a1,0(s7)
    50ce:	855a                	mv	a0,s6
    50d0:	d11ff0ef          	jal	ra,4de0 <putc>
    50d4:	8bca                	mv	s7,s2
      state = 0;
    50d6:	4981                	li	s3,0
    50d8:	bd31                	j	4ef4 <vprintf+0x5a>
        if((s = va_arg(ap, char*)) == 0)
    50da:	008b8993          	addi	s3,s7,8
    50de:	000bb903          	ld	s2,0(s7)
    50e2:	00090f63          	beqz	s2,5100 <vprintf+0x266>
        for(; *s; s++)
    50e6:	00094583          	lbu	a1,0(s2)
    50ea:	c195                	beqz	a1,510e <vprintf+0x274>
          putc(fd, *s);
    50ec:	855a                	mv	a0,s6
    50ee:	cf3ff0ef          	jal	ra,4de0 <putc>
        for(; *s; s++)
    50f2:	0905                	addi	s2,s2,1
    50f4:	00094583          	lbu	a1,0(s2)
    50f8:	f9f5                	bnez	a1,50ec <vprintf+0x252>
        if((s = va_arg(ap, char*)) == 0)
    50fa:	8bce                	mv	s7,s3
      state = 0;
    50fc:	4981                	li	s3,0
    50fe:	bbdd                	j	4ef4 <vprintf+0x5a>
          s = "(null)";
    5100:	00003917          	auipc	s2,0x3
    5104:	82090913          	addi	s2,s2,-2016 # 7920 <malloc+0x270a>
        for(; *s; s++)
    5108:	02800593          	li	a1,40
    510c:	b7c5                	j	50ec <vprintf+0x252>
        if((s = va_arg(ap, char*)) == 0)
    510e:	8bce                	mv	s7,s3
      state = 0;
    5110:	4981                	li	s3,0
    5112:	b3cd                	j	4ef4 <vprintf+0x5a>
    }
  }
}
    5114:	70e6                	ld	ra,120(sp)
    5116:	7446                	ld	s0,112(sp)
    5118:	74a6                	ld	s1,104(sp)
    511a:	7906                	ld	s2,96(sp)
    511c:	69e6                	ld	s3,88(sp)
    511e:	6a46                	ld	s4,80(sp)
    5120:	6aa6                	ld	s5,72(sp)
    5122:	6b06                	ld	s6,64(sp)
    5124:	7be2                	ld	s7,56(sp)
    5126:	7c42                	ld	s8,48(sp)
    5128:	7ca2                	ld	s9,40(sp)
    512a:	7d02                	ld	s10,32(sp)
    512c:	6de2                	ld	s11,24(sp)
    512e:	6109                	addi	sp,sp,128
    5130:	8082                	ret

0000000000005132 <fprintf>:

void
fprintf(int fd, const char *fmt, ...)
{
    5132:	715d                	addi	sp,sp,-80
    5134:	ec06                	sd	ra,24(sp)
    5136:	e822                	sd	s0,16(sp)
    5138:	1000                	addi	s0,sp,32
    513a:	e010                	sd	a2,0(s0)
    513c:	e414                	sd	a3,8(s0)
    513e:	e818                	sd	a4,16(s0)
    5140:	ec1c                	sd	a5,24(s0)
    5142:	03043023          	sd	a6,32(s0)
    5146:	03143423          	sd	a7,40(s0)
  va_list ap;

  va_start(ap, fmt);
    514a:	fe843423          	sd	s0,-24(s0)
  vprintf(fd, fmt, ap);
    514e:	8622                	mv	a2,s0
    5150:	d4bff0ef          	jal	ra,4e9a <vprintf>
}
    5154:	60e2                	ld	ra,24(sp)
    5156:	6442                	ld	s0,16(sp)
    5158:	6161                	addi	sp,sp,80
    515a:	8082                	ret

000000000000515c <printf>:

void
printf(const char *fmt, ...)
{
    515c:	711d                	addi	sp,sp,-96
    515e:	ec06                	sd	ra,24(sp)
    5160:	e822                	sd	s0,16(sp)
    5162:	1000                	addi	s0,sp,32
    5164:	e40c                	sd	a1,8(s0)
    5166:	e810                	sd	a2,16(s0)
    5168:	ec14                	sd	a3,24(s0)
    516a:	f018                	sd	a4,32(s0)
    516c:	f41c                	sd	a5,40(s0)
    516e:	03043823          	sd	a6,48(s0)
    5172:	03143c23          	sd	a7,56(s0)
  va_list ap;

  va_start(ap, fmt);
    5176:	00840613          	addi	a2,s0,8
    517a:	fec43423          	sd	a2,-24(s0)
  vprintf(1, fmt, ap);
    517e:	85aa                	mv	a1,a0
    5180:	4505                	li	a0,1
    5182:	d19ff0ef          	jal	ra,4e9a <vprintf>
}
    5186:	60e2                	ld	ra,24(sp)
    5188:	6442                	ld	s0,16(sp)
    518a:	6125                	addi	sp,sp,96
    518c:	8082                	ret

000000000000518e <free>:
static Header base;
static Header *freep;
...
free(void *ap)
{
    518e:	1141                	addi	sp,sp,-16
    5190:	e422                	sd	s0,8(sp)
    5192:	0800                	addi	s0,sp,16
  Header *bp, *p;

  bp = (Header*)ap - 1;
    5194:	ff050693          	addi	a3,a0,-16
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    5198:	00003797          	auipc	a5,0x3
    519c:	2f87b783          	ld	a5,760(a5) # 8490 <freep>
    51a0:	a805                	j	51d0 <free+0x42>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
      break;
  if(bp + bp->s.size == p->s.ptr){
    bp->s.size += p->s.ptr->s.size;
    51a2:	4618                	lw	a4,8(a2)
    51a4:	9db9                	addw	a1,a1,a4
    51a6:	feb52c23          	sw	a1,-8(a0)
    bp->s.ptr = p->s.ptr->s.ptr;
    51aa:	6398                	ld	a4,0(a5)
    51ac:	6318                	ld	a4,0(a4)
    51ae:	fee53823          	sd	a4,-16(a0)
    51b2:	a091                	j	51f6 <free+0x68>
  } else
    bp->s.ptr = p->s.ptr;
  if(p + p->s.size == bp){
    p->s.size += bp->s.size;
    51b4:	ff852703          	lw	a4,-8(a0)
    51b8:	9e39                	addw	a2,a2,a4
    51ba:	c790                	sw	a2,8(a5)
    p->s.ptr = bp->s.ptr;
    51bc:	ff053703          	ld	a4,-16(a0)
    51c0:	e398                	sd	a4,0(a5)
    51c2:	a099                	j	5208 <free+0x7a>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    51c4:	6398                	ld	a4,0(a5)
    51c6:	00e7e463          	bltu	a5,a4,51ce <free+0x40>
    51ca:	00e6ea63          	bltu	a3,a4,51de <free+0x50>
{
    51ce:	87ba                	mv	a5,a4
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    51d0:	fed7fae3          	bgeu	a5,a3,51c4 <free+0x36>
    51d4:	6398                	ld	a4,0(a5)
    51d6:	00e6e463          	bltu	a3,a4,51de <free+0x50>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    51da:	fee7eae3          	bltu	a5,a4,51ce <free+0x40>
  if(bp + bp->s.size == p->s.ptr){
    51de:	ff852583          	lw	a1,-8(a0)
    51e2:	6390                	ld	a2,0(a5)
    51e4:	02059713          	slli	a4,a1,0x20
    51e8:	9301                	srli	a4,a4,0x20
    51ea:	0712                	slli	a4,a4,0x4
    51ec:	9736                	add	a4,a4,a3
    51ee:	fae60ae3          	beq	a2,a4,51a2 <free+0x14>
    bp->s.ptr = p->s.ptr;
    51f2:	fec53823          	sd	a2,-16(a0)
  if(p + p->s.size == bp){
    51f6:	4790                	lw	a2,8(a5)
    51f8:	02061713          	slli	a4,a2,0x20
    51fc:	9301                	srli	a4,a4,0x20
    51fe:	0712                	slli	a4,a4,0x4
    5200:	973e                	add	a4,a4,a5
    5202:	fae689e3          	beq	a3,a4,51b4 <free+0x26>
  } else
    p->s.ptr = bp;
    5206:	e394                	sd	a3,0(a5)
  freep = p;
    5208:	00003717          	auipc	a4,0x3
    520c:	28f73423          	sd	a5,648(a4) # 8490 <freep>
}
    5210:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
    ...
    521c:	f426                	sd	s1,40(sp)
    521e:	f04a                	sd	s2,32(sp)
    5220:	ec4e                	sd	s3,24(sp)
    5222:	e852                	sd	s4,16(sp)
    5224:	e456                	sd	s5,8(sp)
    5226:	e05a                	sd	s6,0(sp)
    5228:	0080                	addi	s0,sp,64
  Header *p, *prevp;
  uint nunits;

  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    522a:	02051493          	slli	s1,a0,0x20
    522e:	9081                	srli	s1,s1,0x20
    5230:	04bd                	addi	s1,s1,15
    5232:	8091                	srli	s1,s1,0x4
    5234:	0014899b          	addiw	s3,s1,1
    5238:	0485                	addi	s1,s1,1
  if((prevp = freep) == 0){
    523a:	00003517          	auipc	a0,0x3
    523e:	25653503          	ld	a0,598(a0) # 8490 <freep>
    5242:	c515                	beqz	a0,526e <malloc+0x58>
    base.s.ptr = freep = prevp = &base;
    base.s.size = 0;
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    5244:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
    5246:	4798                	lw	a4,8(a5)
    5248:	02977f63          	bgeu	a4,s1,5286 <malloc+0x70>
    524c:	8a4e                	mv	s4,s3
    524e:	0009871b          	sext.w	a4,s3
    5252:	6685                	lui	a3,0x1
    5254:	00d77363          	bgeu	a4,a3,525a <malloc+0x44>
    5258:	6a05                	lui	s4,0x1
    525a:	000a0b1b          	sext.w	s6,s4
  p = sbrk(nu * sizeof(Header));
    525e:	004a1a1b          	slliw	s4,s4,0x4
        p->s.size = nunits;
      }
      freep = prevp;
      return (void*)(p + 1);
    ...
    if(p == freep)
    5262:	00003917          	auipc	s2,0x3
    5266:	22e90913          	addi	s2,s2,558 # 8490 <freep>
  if(p == SBRK_ERROR)
    526a:	5afd                	li	s5,-1
    526c:	a0bd                	j	52da <malloc+0xc4>
    base.s.ptr = freep = prevp = &base;
    526e:	0000a797          	auipc	a5,0xa
    5272:	a4a78793          	addi	a5,a5,-1462 # ecb8 <base>
    5276:	00003717          	auipc	a4,0x3
    527a:	20f73d23          	sd	a5,538(a4) # 8490 <freep>
    527e:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
    5280:	0007a423          	sw	zero,8(a5)
    if(p->s.size >= nunits){
    5284:	b7e1                	j	524c <malloc+0x36>
      if(p->s.size == nunits)
    5286:	02e48b63          	beq	s1,a4,52bc <malloc+0xa6>
        p->s.size -= nunits;
    528a:	4137073b          	subw	a4,a4,s3
    528e:	c798                	sw	a4,8(a5)
        p += p->s.size;
    5290:	1702                	slli	a4,a4,0x20
    5292:	9301                	srli	a4,a4,0x20
    5294:	0712                	slli	a4,a4,0x4
    5296:	97ba                	add	a5,a5,a4
        p->s.size = nunits;
    5298:	0137a423          	sw	s3,8(a5)
      freep = prevp;
    529c:	00003717          	auipc	a4,0x3
    52a0:	1ea73a23          	sd	a0,500(a4) # 8490 <freep>
      return (void*)(p + 1);
    52a4:	01078513          	addi	a0,a5,16
      if((p = morecore(nunits)) == 0)
        return 0;
  }
}
    52a8:	70e2                	ld	ra,56(sp)
    52aa:	7442                	ld	s0,48(sp)
    52ac:	74a2                	ld	s1,40(sp)
    52ae:	7902                	ld	s2,32(sp)
    52b0:	69e2                	ld	s3,24(sp)
    ...
    52ba:	8082                	ret
        prevp->s.ptr = p->s.ptr;
    52bc:	6398                	ld	a4,0(a5)
    52be:	e118                	sd	a4,0(a0)
    52c0:	bff1                	j	529c <malloc+0x86>
  hp->s.size = nu;
    52c2:	01652423          	sw	s6,8(a0)
  free((void*)(hp + 1));
    52c6:	0541                	addi	a0,a0,16
    52c8:	ec7ff0ef          	jal	ra,518e <free>
  return freep;
    52cc:	00093503          	ld	a0,0(s2)
      if((p = morecore(nunits)) == 0)
    52d0:	dd61                	beqz	a0,52a8 <malloc+0x92>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    52d2:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
    52d4:	4798                	lw	a4,8(a5)
    52d6:	fa9778e3          	bgeu	a4,s1,5286 <malloc+0x70>
    if(p == freep)
    52da:	00093703          	ld	a4,0(s2)
    52de:	853e                	mv	a0,a5
    52e0:	fef719e3          	bne	a4,a5,52d2 <malloc+0xbc>
  p = sbrk(nu * sizeof(Header));
    52e4:	8552                	mv	a0,s4
    52e6:	a17ff0ef          	jal	ra,4cfc <sbrk>
  if(p == SBRK_ERROR)
    52ea:	fd551ce3          	bne	a0,s5,52c2 <malloc+0xac>
        return 0;
    52ee:	4501                	li	a0,0
    52f0:	bf65                	j	52a8 <malloc+0x92>
